...
class Edit extends Action
{
    ...
    public function execute()
    {
        ...
        $updateCollection = $this->_objectManager->create('Wiki\VendorsConfigApproval\Model\ResourceModel\Config\Collection');
        $updateCollection->addFieldToFilter('vendor_id', $id)
            ->addFieldToFilter('status', \Wiki\VendorsConfigApproval\Model\Config::STATUS_PENDING);
