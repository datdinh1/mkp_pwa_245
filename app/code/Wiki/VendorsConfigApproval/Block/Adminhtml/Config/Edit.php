...
namespace Wiki\VendorsConfigApproval\Block\Adminhtml\Config;

use Wiki\VendorsConfigApproval\Model\ResourceModel\Config\CollectionFactory;
use Magento\Config\Model\Config\Structure\Reader as ConfigReader;
use Wiki\VendorsConfig\Helper\Data as ConfigHelper;
use Wiki\VendorsConfigApproval\Model\Config as ConfigApproval;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'id';
        $this->_blockGroup = 'Wiki_VendorsConfigApproval';
