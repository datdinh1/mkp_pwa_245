...
namespace Wiki\SmTheme\Observer;

use Magento\Framework\Event\ObserverInterface;
use Magento\Framework\Controller\Result\JsonFactory;

class VendorSearch implements ObserverInterface
{    
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
    	...
    	if($controller->getRequest()->getParam('vesAjax')){
	    	$productsBlockHtml = $this->view->getLayout()->getBlock('search_result_list')->unsetChild('product_list_toolbar')->toHtml();
