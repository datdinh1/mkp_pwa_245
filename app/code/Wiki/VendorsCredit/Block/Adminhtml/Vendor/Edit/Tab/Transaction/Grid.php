...
class Grid extends \Magento\Backend\Block\Dashboard\Grid
{
    ...
    /*
     * @var \Wiki\Credit\Model\Source\Transaction\Type
     */
    ...
    public function __construct(
        ...
        \Wiki\Credit\Model\Source\Transaction\Type $transactionType,
        \Wiki\Credit\Model\ResourceModel\Credit\Transaction\CollectionFactory $collectionFactory,
    ...
    {
        parent::_construct();
        $this->setId('creditTransactionsGrid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'text',
                'index' => 'description',
                'renderer' => 'Wiki\VendorsCredit\Block\Adminhtml\Vendor\Edit\Tab\Transaction\Description',
            ]
        );
    ...
    {
        return $this->getUrl('vendors/credit_transactions/grid', ['_current'=>true]);
    }
}
