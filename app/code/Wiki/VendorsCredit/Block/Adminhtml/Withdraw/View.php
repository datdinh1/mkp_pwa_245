...
namespace Wiki\VendorsCredit\Block\Adminhtml\Withdraw;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_template = 'Wiki_VendorsCredit::widget/form/container.phtml';
    ...
    {
        $this->_objectId = 'id';
        $this->_blockGroup = 'Wiki_VendorsCredit';
