...
namespace Wiki\VendorsCredit\Block\Adminhtml\Withdraw\View\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
       ...
       // $form->setUseContainer(true);
        ...
        $fieldset->addType('status', 'Wiki\VendorsCredit\Block\Form\Element\Status');
        $fieldset->addType('price', 'Wiki\VendorsCredit\Block\Form\Element\Price');
        $fieldset->addField(
            'payment_method',
            'label',
        ...
        if($withdrawal->getStatus() == \Wiki\VendorsCredit\Model\Withdrawal::STATUS_PENDING){
            $fieldset->addField(
                'code_of_transfer',
                'text',
            ...
            if($withdrawal->getStatus() == \Wiki\VendorsCredit\Model\Withdrawal::STATUS_CANCELED){
                $fieldset->addField(
                    'reason_cancel',
                    'label',
