...
namespace Wiki\VendorsCredit\Block\Adminhtml\Escrow\View\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('invoice', 'Wiki\VendorsCredit\Block\Form\Element\Invoice');
        $fieldset->addType('order', 'Wiki\VendorsCredit\Block\Form\Element\Order');
        $fieldset->addField(
            'escrow_id',
            'label',
