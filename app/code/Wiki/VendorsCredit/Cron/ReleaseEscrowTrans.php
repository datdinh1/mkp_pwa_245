 ...
 */
namespace Wiki\VendorsCredit\Cron;

use Wiki\VendorsCredit\Model\ResourceModel\Escrow\CollectionFactory;

class ReleaseEscrowTrans
{
    /**
     * @var \Wiki\VendorsCredit\Model\ResourceModel\Escrow\CollectionFactory
     */
    ...
    public function __construct(
        ...
        \Wiki\VendorsCredit\Helper\Data $creditHelper
    ) {
    ...
    public function execute()
    {
        ...
        $collection->addFieldToFilter('status', \Wiki\VendorsCredit\Model\Escrow::STATUS_PENDING)
