...
namespace Wiki\VendorsCredit\Ui\Component\Listing\Column;
...
class Commission extends Column
{
    ...
    protected function getOrderCommission($orderId)
    {
        ...
        $creditTransactionCollection = $om->create('Wiki\Credit\Model\ResourceModel\Credit\Transaction\Collection');
