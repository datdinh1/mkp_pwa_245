...
use Wiki\VendorsCredit\Model\ResourceModel\Withdrawal\CollectionFactory;
...
class PendingWithdrawalObserver implements ObserverInterface
{
    ...
    /**
     * Vendor collection
     * @var \Wiki\Vendors\Model\ResourceModel\Vendor\Collection
     */
    ...
    public function __construct(
        ...
        $this->_withdrawalCollection->addFieldToFilter('status', \Wiki\VendorsCredit\Model\Withdrawal::STATUS_PENDING);
    }
