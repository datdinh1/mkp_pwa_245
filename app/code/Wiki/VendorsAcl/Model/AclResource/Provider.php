...
namespace Wiki\VendorsAcl\Model\AclResource;

use Magento\Framework\Serialize\Serializer\Json;
use Magento\Framework\Acl\AclResource\TreeBuilder;
use Magento\Framework\App\ObjectManager;

class Provider implements \Magento\Framework\Acl\AclResource\ProviderInterface 
{
    /**
     * Cache key for ACL roles cache
     */
    const ACL_RESOURCES_CACHE_KEY = 'Wiki_vendorssubaccount_acl_resources_cache';
