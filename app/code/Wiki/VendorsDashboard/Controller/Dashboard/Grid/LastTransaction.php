 ...
 */
namespace Wiki\VendorsDashboard\Controller\Dashboard\Grid;

use Magento\Framework\Registry;
use Magento\Framework\Stdlib\DateTime\Filter\Date;

class LastTransaction extends \Wiki\Vendors\Controller\Vendors\Action
{
    /**
    ...
    public function execute()
    {
        ...
        $output = $this->_view->getLayout()
            ->createBlock('Wiki\VendorsDashboard\Block\Vendors\Dashboard\Transaction\Grid')
            ->toHtml();
