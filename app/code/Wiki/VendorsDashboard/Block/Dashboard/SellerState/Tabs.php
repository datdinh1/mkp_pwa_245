 ...
 * Vendor tabs
 */
namespace Wiki\VendorsDashboard\Block\Dashboard\SellerState;

class Tabs extends \Wiki\VendorsDashboard\Block\Vendors\Dashboard\SellerState\Tabs
{
    /**
    ...
    public function getOrderTabContent()
    {
        return $this->getLayout()->createBlock(
            'Wiki\VendorsDashboard\Block\Dashboard\Order\Grid'
        )->toHtml();
    }
}
