 ...
 */
namespace Wiki\VendorsProduct\Block\Adminhtml\Product\Attribute\Set;

use Magento\Catalog\Model\Entity\Product\Attribute\Group\AttributeMapperInterface;
use Wiki\VendorsProduct\Model\Entity\Product\Attribute\Group\AttributeMapper;
...
class Main extends \Magento\Catalog\Block\Adminhtml\Product\Attribute\Set\Main
{
     ...
     * @var string
     */
    protected $_template = 'Wiki_VendorsProduct::catalog/product/attribute/set/main.phtml';

    /**
     * @var Wiki\VendorsProduct\Model\Entity\Product\Attribute\Group\AttributeMapper
     */
    protected $_newAttributeMapper;
    
    /**
     * @var \Wiki\VendorsProduct\Model\Entity\Attribute\SetFactory
     */
    protected $_customAttributeSetFactory;
    
    /**
     * @var \Wiki\VendorsProduct\Model\Entity\Attribute\Group
     */
    protected $_customGroupFactory;
    
    /**
     * Attribute collection
     * @var \Wiki\VendorsProduct\Model\ResourceModel\Entity\Attribute\CollectionFactory
     */
    ...
    protected function _prepareLayout()
    {
        ...
        $data = [];
        $block = 'Wiki\VendorsProduct\Block\Adminhtml\Product\Attribute\Set\Main\Formset';
    ...
    public function __construct(
        ...
        \Wiki\VendorsProduct\Model\Entity\Attribute\SetFactory $customAttributeSetFactory,
        \Wiki\VendorsProduct\Model\Entity\Attribute\GroupFactory $customGroupFactory,
        \Wiki\VendorsProduct\Model\ResourceModel\Entity\Attribute\CollectionFactory $customCollectionFactory,
        array $data = []
    ) {
    ...
    public function getGroupTreeJson()
    {
        ...
        $items = [];
        /* @var $groups \Wiki\VendorsProduct\Model\ResourceModel\Entity\Attribute\Group\Collection */
