 ...
 */
namespace Wiki\VendorsProduct\Block\Product\Widget;

/**
 * New products widget
 */
class NewWidget extends \Wiki\VendorsProduct\Block\Product\NewProduct implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    protected function _getRecentlyAddedProductsCollection()
    {
        ...
        $vendorHelper = $object_manager->get('Wiki\Vendors\Helper\Data');
        $notActiveVendorIds = $vendorHelper->getNotActiveVendorIds();

        $productHelper = $object_manager->get('Wiki\VendorsProduct\Helper\Data');
