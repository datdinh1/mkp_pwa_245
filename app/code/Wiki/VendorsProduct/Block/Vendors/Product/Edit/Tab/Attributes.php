...
namespace Wiki\VendorsProduct\Block\Vendors\Product\Edit\Tab;
...
class Attributes extends \Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Attributes
{
     ...
     * @var string
     */
    protected $_template = 'Wiki_Vendors::widget/form.phtml';
    ...
    protected function _prepareForm()
    {
        ...
        if ($tierPrice) {
            $tierPrice->setRenderer(
                $this->getLayout()->createBlock('Wiki\VendorsProduct\Block\Vendors\Product\Edit\Tab\Price\Tier')
            );
        }
    ...
    {
        $result = [
            'price' => 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\Price',
            'weight' => 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\Weight',
            'gallery' => 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\Gallery',
            'image' => 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\Image',
    ...
    protected function _prepareLayout()
    {
        \Magento\Framework\Data\Form::setElementRenderer(
            $this->getLayout()->createBlock(
                'Wiki\Vendors\Block\Vendors\Widget\Form\Renderer\Element',
                $this->getNameInLayout() . '_element'
            )
        );
        \Magento\Framework\Data\Form::setFieldsetRenderer(
            $this->getLayout()->createBlock(
                'Wiki\Vendors\Block\Vendors\Widget\Form\Renderer\Fieldset',
                $this->getNameInLayout() . '_fieldset'
            )
        );
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Wiki\VendorsProduct\Block\Vendors\Form\Renderer\Fieldset\Element',
        ...
        foreach ($attributes as $attribute) {
            ...
            if (($inputType = $attribute->getFrontend()->getInputType()) && !in_array(
                ...
                if ($attribute->getAttributeCode() == 'category_ids') {
                    $rendererClass = 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\Category';
                } elseif ($attribute->getAttributeCode() == 'weight') {
                    $rendererClass = 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\Weight';
                } elseif ($attribute->getAttributeCode() == 'image') {
                    $rendererClass = 'Wiki\VendorsProduct\Block\Vendors\Product\Helper\Form\BaseImage';
                }
