...
use Wiki\Vendors\Block\Vendors\Widget\Tabs as WigetTabs;
...
use Wiki\VendorsProduct\Model\Entity\Attribute\Set as VendorProductAttributeSet;
...
class Tabs extends \Magento\Catalog\Block\Adminhtml\Product\Edit\Tabs
{
    ...
    /**
     * @var Wiki\VendorsProduct\Model\Entity\Attribute\Set
     */
     ...
     * @var string
     */
    protected $_attributeTabBlock = 'Wiki\VendorsProduct\Block\Vendors\Product\Edit\Tab\Attributes';

    /**
     * @var string
     */
    protected $_template = 'Wiki_VendorsProduct::product/edit/tabs.phtml';
    ...
    public function __construct(
        ...
        \Wiki\VendorsProduct\Model\ResourceModel\Entity\Attribute\CollectionFactory $customAttributeCollectionFactory,
        array $data = []
    ) {
        parent::__construct(
            $context,
...
//                         'Wiki\VendorsProduct\Block\Vendors\Product\Edit\Tab\Websites'
//                     )->toHtml()
//                 )
//             );
        }
    ...
    protected function _prepareTabs()
    {
        ...
        foreach ($this->_attributeSet->getGroupCollection() as $group) {
            /** @var $group \Wiki\VendorsProduct\Model\Entity\Attribute\Group*/
