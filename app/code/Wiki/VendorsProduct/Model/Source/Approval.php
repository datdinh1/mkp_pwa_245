 ...
 */
namespace Wiki\VendorsProduct\Model\Source;
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            $this->_options = [
                ...
                ['label' => __('Pending New'), 'value' => self::STATUS_PENDING],
                ['label' => __('Pending Update'), 'value' => self::STATUS_PENDING_UPDATE],
