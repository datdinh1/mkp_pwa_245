<?php
/**
 * Copyright © 2017 Wiki, Inc. All rights reserved.
 * See COPYING.txt for license details.
 */
namespace Wiki\VendorsProduct\Model\ResourceModel\Layer\Filter;
...
class Price extends \Magento\Catalog\Model\ResourceModel\Layer\Filter\Price
{
    ...
    {
        $om = \Magento\Framework\App\ObjectManager::getInstance();
        $notAllowVendors = $om->create('Wiki\Vendors\Helper\Data')->getNotActiveVendorIds();
