 ...
 */
namespace Wiki\VendorsProduct\Controller\Catalog\Product;
...
class NewAction extends \Wiki\VendorsProduct\Controller\Catalog\Product
{
    /**
    ...
    public function execute()
    {
        ...
        if ($this->_config->getValue('vendors/catalog/product_edit_tabs_template') == \Wiki\VendorsProduct\Model\Config\Source\Tab\Template::TEMPLATE_HORIZONTAL_TABS) {
