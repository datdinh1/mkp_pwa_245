...
class Save extends \Wiki\VendorsProduct\Controller\Vendors\Product
{
	/**
     ...
     * @see _isAllowed()
     */
    protected $_aclResource = 'Wiki_Vendors::product_action_save';
            ...
            try {
                ...
                */
                    ...
                    if ($this->vendorProductHelper->isUpdateProductsApproval()) {
                        if (!in_array($product->getApproval(), [Approval::STATUS_PENDING, Approval::STATUS_NOT_SUBMITED, Approval::STATUS_UNAPPROVED])) {
                            ...
                            if (sizeof($changedData)) {
                                ...
                                /*Save changed data*/
                                $update = $this->_objectManager->create('Wiki\VendorsProduct\Model\Product\Update');
                ...
                if ($saveProductFlag) {
                    ...
                    $this->_objectManager->create('Wiki\VendorsProduct\Controller\Vendors\Product\Initialization\Helper')->initialize($tmpProduct);
    ...
    private function compareAttributeValue($attrCode, $attrType, $data, $originData)
    {
        ...
        $this->_eventManager->dispatch('Wiki_vendorsproduct_compare_attribute_value', ['transport' => $transport]);
