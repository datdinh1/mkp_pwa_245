...
namespace Wiki\VendorsCustomWithdrawal\Block\Vendors\Withdraw\Method;
 ...
 */
class Custom extends \Wiki\VendorsCredit\Block\Vendors\Withdraw\Method\AbstractBlock
{
    protected $_template = 'Wiki_VendorsCustomWithdrawal::withdraw/method/custom.phtml';
    ...
    public function getFieldInfo($field){
        $session = ObjectManager::getInstance()->get('Wiki\Vendors\Model\Session');
    ...
    public function getSavedData(){
        ...
        $methodData = $om->create('Wiki\VendorsCustomWithdrawal\Model\Method\Data');
