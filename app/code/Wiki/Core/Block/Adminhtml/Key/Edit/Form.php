...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($model->getId()) {
            ...
            )->setRenderer($this->getLayout()->createBlock('Wiki\Core\Block\Adminhtml\Key\Edit\Renderer\Domains'));
            $form->setValues($data);
        }else{
            /*Add new license*/
            $fieldset->addField(
                ...
                [
                    ...
                    'required' => true, 
                    'note' => __("Enter the license key which you got when you purchase an extension from www.Wiki.com.")
                ]
            );
        }
