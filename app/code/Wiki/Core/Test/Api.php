...
class Api
{
    const Wiki_URL = 'https://www.Wiki.com/license/info';
    ...
    {
        $client = new Client(self::Wiki_URL.'/index', [
            'maxredirects' => 0,
            'timeout' => 120,
        ]);
    ...
    public function getExtensionsList()
    {
        ...
        if (!$fileExist || $reupdate) {
            ...
            $client = new Client(self::Wiki_URL.'/extensions', [
                'maxredirects' => 0,
                'timeout' => 120,
            ]);
    ...
    {
        $client = new Client(self::Wiki_URL.'/save', [
            'maxredirects' => 0,
            'timeout' => 120,
        ]);
     ...
     * 
     * @param \Wiki\Core\Model\Key $key
     *
     * @return bool|Ambigous <boolean, mixed>
     */
    public function getSavedKeyInfo(\Wiki\Core\Model\Key $key)
    {
    ...
    public function renderLicenseInfo(\Wiki\Core\Model\Key $key)
    {
