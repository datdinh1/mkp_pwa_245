 ...
 */
namespace Wiki\VendorsPage\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface
{
    ...
    public function __construct(
        ...
        \Wiki\VendorsPage\Helper\Data $vendorPageHelper,
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        if (!$vendor->getId() || $vendor->getStatus() != \Wiki\Vendors\Model\Vendor::STATUS_APPROVED) {
            return null;
        }
