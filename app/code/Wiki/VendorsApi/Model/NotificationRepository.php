...
use Wiki\VendorsApi\Api\Data\NotificationSearchResultInterfaceFactory as SearchResultFactory;
use Wiki\VendorsApi\Helper\Data as ApiHelper;

/**
 * notification repository.
 */
class NotificationRepository implements \Wiki\VendorsApi\Api\NotificationRepositoryInterface
{
    /**
     * @var ApiHelper
     */
    ...
    public function getList(
        ...
        /** @var \Wiki\VendorsApi\Api\Data\NotificationSearchResultInterface $searchResult */
    ...
    public function getUnreadCount($customerId){
        ...
        $collection = $om->create('Wiki\VendorsNotification\Model\ResourceModel\Notification\Collection');
    ...
    public function deleteById($notificationId, $customerId){
        ...
        $vendorId = $vendor->getId();
        $om = ObjectManager::getInstance();
        $collection = $om->create('Wiki\VendorsNotification\Model\Notification')->load($notificationId);
