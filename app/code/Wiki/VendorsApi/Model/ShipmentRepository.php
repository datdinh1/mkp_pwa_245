...
use Wiki\VendorsSales\Model\ResourceModel\Order\Shipment\Grid\CollectionFactory as VendorShipmentGridCollectionFactory;
use Magento\Framework\Api\DataObjectHelper;
use Wiki\VendorsApi\Api\ShipmentRepositoryInterface;
use Magento\Framework\Api\SearchCriteria\CollectionProcessorInterface;
use Wiki\VendorsApi\Api\Data\Sale\ShipmentInterfaceFactory as ShipmentDataInterfaceFactory;
...
class ShipmentRepository implements ShipmentRepositoryInterface
{
    ...
    /**
     * @var \Wiki\VendorsApi\Api\Data\Sale\ShipmentSearchResultInterfaceFactory
     */
     ...
     * @param \Wiki\VendorsApi\Api\Data\Sale\ShipmentSearchResultInterfaceFactory $searchResultFactory
    ...
    public function __construct(
        ...
        \Wiki\VendorsApi\Api\Data\Sale\ShipmentSearchResultInterfaceFactory $searchResultFactory,
    ...
    public function getList(
        ...
        $shipments = [];
        /** @var \Wiki\VendorsSales\Model\ResourceModel\Order\Shipment\Grid\Collection $shipmentModel */
        foreach ($collection as $shipmentModel) {
            $shipmentData = $this->shipmentDataInterfaceFactory->create();
            $this->dataObjectHelper->populateWithArray(
                $shipmentData,
                $shipmentModel->getData(),
                'Wiki\VendorsApi\Api\Data\Sale\ShipmentInterface'
            );
