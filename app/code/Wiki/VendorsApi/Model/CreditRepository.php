...
use Wiki\VendorsApi\Api\Data\Credit\TransactionSearchResultInterfaceFactory as SearchResultFactory;
 ...
 * Vendor repository.
 */
class CreditRepository implements \Wiki\VendorsApi\Api\CreditRepositoryInterface
{
    /**
     * @var ApiHelper
     */
    ...
    /**
     * @see \Wiki\VendorsApi\Api\DashboardRepositoryInterface::getLastOrders()
     */
    public function getTransactions(
        $customerId,
        \Magento\Framework\Api\SearchCriteriaInterface $searchCriteria
    ) {
        /** @var \Wiki\VendorsApi\Api\Data\Credit\TransactionSearchResultInterface $searchResult */
