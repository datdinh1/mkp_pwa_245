...
use Wiki\VendorsSales\Model\ResourceModel\Order\CollectionFactory as VendorOrderCollectionFactory;
 ...
 * Vendor repository.
 */
class OrderRepository implements \Wiki\VendorsApi\Api\OrderRepositoryInterface
{
    /**
     * @var ApiHelper
     */
    ...
    /**
     * @var \Wiki\VendorsApi\Api\Data\Sale\OrderSearchResultInterfaceFactory
     */
    ...
    /**
     * @var \Wiki\VendorsApi\Api\Data\OrderInterfaceFactory
     */
     ...
     * @param \Wiki\VendorsApi\Api\Data\Sale\OrderSearchResultInterfaceFactory $searchResultFactory
     * @param DataObjectHelper $dataObjectHelper
     * @param \Wiki\VendorsApi\Api\Data\Sale\OrderInterfaceFactory $dataOrderFactory
    ...
    public function __construct(
        ...
        \Wiki\VendorsApi\Api\Data\Sale\OrderSearchResultInterfaceFactory $searchResultFactory,
        DataObjectHelper $dataObjectHelper,
        \Wiki\VendorsApi\Api\Data\Sale\OrderInterfaceFactory $dataOrderFactory,
    ...
    public function getOrder($customerId, $orderId){
        ...
        $this->dataObjectHelper->populateWithArray(
            $result,
            $vendorOrder->getData(),
            'Wiki\VendorsApi\Api\Data\Sale\OrderInterface'
        );
     ...
     * @param int $customerId
     * @see \Wiki\VendorsApi\Api\OrderRepositoryInterface::getList()
     * @return \Wiki\VendorsApi\Api\Data\Sale\OrderInterface
     */
    ...
    /**
     * @param \Wiki\VendorsApi\Api\Data\Sale\OrderInterface $orderResult
     * @param \Wiki\VendorsSales\Model\Order $vendorOrder
     */
    protected function addAdditionalInfoToOrderResult(
        \Wiki\VendorsApi\Api\Data\Sale\OrderInterface $orderResult,
        \Wiki\VendorsSales\Model\Order $vendorOrder
    ){
    ...
    protected function getItemOptions($item)
    {
        ...
        foreach ($result as $option) {
            $otp = \Magento\Framework\App\ObjectManager::getInstance()->create(
                'Wiki\VendorsApi\Model\Data\Sale\Order\ItemOption'
            );
    ...
    private function getCollectionProcessor()
    {
        if (!$this->collectionProcessor) {
            $this->collectionProcessor = \Magento\Framework\App\ObjectManager::getInstance()->get(
                'Wiki\VendorsApi\Model\Api\SearchCriteria\VendorsOrderApiCollectionProcessor'
            );
        }
