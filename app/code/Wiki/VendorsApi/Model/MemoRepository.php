...
use Wiki\VendorsSales\Model\ResourceModel\Order\Creditmemo\Grid\CollectionFactory as VendorMemoGridCollectionFactory;
use Magento\Framework\Api\DataObjectHelper as DataObjectHelper;
use Wiki\VendorsApi\Api\MemoRepositoryInterface;
use Magento\Framework\Api\SearchCriteria\CollectionProcessorInterface;
use Wiki\VendorsSales\Model\Service\MemoService;
use Wiki\VendorsApi\Api\Data\Sale\MemoInterfaceFactory as MemoDataInterfaceFactory;
...
class MemoRepository implements MemoRepositoryInterface
{
    ...
    /**
     * @var \Wiki\VendorsApi\Api\Data\Sale\MemoSearchResultInterfaceFactory
     */
     ...
     * @param \Wiki\VendorsApi\Api\Data\Sale\MemoSearchResultInterfaceFactory $searchResultFactory
    ...
    public function __construct(
        ...
        \Wiki\VendorsApi\Api\Data\Sale\MemoSearchResultInterfaceFactory $searchResultFactory,
    ...
    public function getList(
        ...
        $memos = [];
        /** @var \Wiki\VendorsSales\Model\ResourceModel\Order\Creditmemo\Grid\Collection $memoModel */
        foreach ($collection as $memoModel) {
            $memoData = $this->memoDataInterfaceFactory->create();
            $this->dataObjectHelper->populateWithArray(
                $memoData,
                $memoModel->getData(),
                'Wiki\VendorsApi\Api\Data\Sale\MemoInterface'
            );
            $memos[] = $memoData;
        }
