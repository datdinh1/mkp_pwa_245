<?php
namespace Wiki\VendorsProfileNotification\Block\Adminhtml\Process\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    */
    ...
    protected function _prepareForm()
    {
        ...
        if(!$model->getId()){
            $model->setStatus(\Wiki\VendorsProfileNotification\Model\Process::STATUS_ENABLED);
        }
