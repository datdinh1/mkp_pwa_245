...
use Wiki\Vendors\Model\ResourceModel\Attribute\CollectionFactory;
...
class Attribute extends AbstractType
{
    ...
    /**
     * (non-PHPdoc)
     * @see \Wiki\VendorsProfileNotification\Model\Type\AbstractType::getTitle()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Wiki\VendorsProfileNotification\Model\Type\AbstractType::prepareForm()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Wiki\VendorsProfileNotification\Model\Type\AbstractType::beforeSaveProcess()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Wiki\VendorsProfileNotification\Model\Type\AbstractType::afterLoadProcess()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Wiki\VendorsProfileNotification\Model\Type\AbstractType::isCompletedProcess()
     */
    ...
    /**
     * (non-PHPdoc)
     * @see \Wiki\VendorsProfileNotification\Model\Type\AbstractType::getUrl()
     */
