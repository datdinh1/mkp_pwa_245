 ...
 * Contact base helper
 */
class AdditionData extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getCssUrl($themeId){
		return $this->_url->getUrl('vendorspage/ThemePage/css',['store'=>$this->getStore()->getId(),'themeId' => $themeId]);
	}
    ...
    public function getThemecolorSetting($storeId, $themeName) {
		$setting = [];
		$dir = $this->_filesystem->getDirectoryRead(DirectoryList::APP)->getAbsolutePath('code/Wiki/VendorsCustomTheme/data/themes/marketplace');
    ...
    public function getHeaderColorSetting($storeId, $data, $value) {
    ...
    public function getMainColorSetting($storeId, $data, $value) {
		$setting = [];
		if($data == "text_color"){
			$setting = [
				'body' => [
		...
		if($data == "button_background_hover_df"){
			$setting = [
				'.btn-default2:hover,.btn-default2:focus,.btn-default2:active' => [
                	'background-color' => $value
				]
		...
		if($data == "button_border_hover_df"){
			$setting = [
				'.btn-default2:hover,.btn-default2:focus,.btn-default2:active' => [
                	'border-color' => $value
				]
		...
		if($data == "primary_button_background"){
			$setting = [
				'.btn-primary' => [
                	'background-color' => $value
				]
		...
		if($data == "primary_button_text_hover"){
			$setting = [
		...
		if($data == "primary_button_background_hover"){
			$setting = [
				'.btn-primary:hover,.btn-primary:focus,.btn-primary:active' => [
                	'background-color' => $value
				]
		...
		if($data == "primary_button_border_hover"){
			$setting = [
				'.btn-primary:hover,.btn-primary:focus,.btn-primary:active' => [
                	'border-color' => $value
				]
		...
		if($data == "secondary_button_background"){
			$setting = [
				'.btn-secondary' => [
                	'background-color' => $value
				]
		...
		if($data == "secondary_button_border"){
			$setting = [
				'.btn-secondary' => [
                	'border-color' => $value
				]
		...
		if($data == "secondary_button_text_hover"){
			$setting = [
		...
		if($data == "secondary_button_background_hover"){
			$setting = [
				'.btn-secondary:hover,.btn-secondary:focus,.btn-secondary:active' => [
                	'background-color' => $value
				]
		...
		if($data == "secondary_button_border_hover"){
			$setting = [
				'.btn-secondary:hover,.btn-secondary:focus,.btn-secondary:active' => [
                	'border-color' => $value
				]
	...
	// get main content custom color
    public function getFooterColorSetting($storeId, $data, $value) {
        $setting = $arrAttribute = [];
		$dir = $this->_filesystem->getDirectoryRead(DirectoryList::APP)->getAbsolutePath('code/Wiki/VendorsCustomTheme/data/themes/marketplace');
		$themeStyleFile = $dir.'/theme_style.xml';
		if (is_readable($themeStyleFile)){
	...
	public function getClearClass($nb_item, $perrow = NULL){
		if(!$perrow){
			$settings = $this->getThemeSettings();
			$perrow = $settings['catalog']['per_row'];
		}
	...
	public function getTreeCategory($category, $parent, $checkedCat, $ids = array()){
