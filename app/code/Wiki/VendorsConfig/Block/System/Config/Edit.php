...
{
    const DEFAULT_VENDOR_SECTION_BLOCK = 'Wiki\VendorsConfig\Block\System\Config\Form';
     ...
     * @var string
     */
    protected $_template = 'Wiki_VendorsConfig::system/config/edit.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getToolbar()->addChild(
            'save_btn',
            'Wiki\Vendors\Block\Vendors\Widget\Button',
            [
                'id' => 'save',
