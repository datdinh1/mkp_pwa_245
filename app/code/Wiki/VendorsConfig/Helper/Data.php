 ...
 */
namespace Wiki\VendorsConfig\Helper;
...
class Data extends AbstractHelper
{
    ...
    /**
     * @param \Wiki\VendorsConfig\App\Config\Initial $initialConfig
    ...
    public function __construct(
        \Wiki\VendorsConfig\App\Config\Initial $initialConfig,
     ...
     *
     * @param array $config
     * @return \Wiki\VendorsConfig\Helper\Data
     */
        ...
        */
        ...
        if (isset($groupData['fields'])) {
            ...
            foreach ($groupData['fields'] as $fieldId => $fieldData) {
                ...
                /** @var \Wiki\VendorsConfig\Model\Config $backendModel */
