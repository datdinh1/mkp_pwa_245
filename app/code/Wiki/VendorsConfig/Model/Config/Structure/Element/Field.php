 ...
 */
namespace Wiki\VendorsConfig\Model\Config\Structure\Element;

class Field extends \Magento\Config\Model\Config\Structure\Element\Field
{
    /**
     * @var \Wiki\VendorsConfig\Model\Config\BackendFactory
     */
    ...
    public function __construct(
        ...
        \Wiki\VendorsConfig\Model\Config\BackendFactory $vendorBackendFactory
    ) {
        parent::__construct(
            $storeManager,
            $moduleManager,
