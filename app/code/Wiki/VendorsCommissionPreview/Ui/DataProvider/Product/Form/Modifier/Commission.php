<?php
namespace Wiki\VendorsCommissionPreview\Ui\DataProvider\Product\Form\Modifier;
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'template' => 'Wiki_VendorsCommissionPreview/commission',
                        'component' => 'Wiki_VendorsCommissionPreview/js/components/commission',
