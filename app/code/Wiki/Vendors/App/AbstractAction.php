...
abstract class AbstractAction extends \Magento\Framework\App\Action\Action
{
    ...
    public function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        if (!$this->_getSession()->isLoggedIn()) {
            $loginUrl = $this->_helper->getSellerRegisterType() == \Wiki\Vendors\Model\Source\RegisterType::TYPE_SEPARATED?
        ...
        if ($vendor->getStatus() != \Wiki\Vendors\Model\Vendor::STATUS_APPROVED) {
            if ($vendor->getStatus() == \Wiki\Vendors\Model\Vendor::STATUS_DISABLED) {
