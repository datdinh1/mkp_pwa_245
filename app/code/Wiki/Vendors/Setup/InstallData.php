...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $setup->getConnection()->insertForce(
            ...
            ['fieldset_id' => 1,'form'=>\Wiki\Vendors\Helper\Data::PROFILE_FORM, 'title' => 'General','sort_order'=>10]
        );
        
        $setup->getConnection()->insertForce(
            $setup->getTable('ves_vendor_fieldset'),
            ['fieldset_id' => 2,'form'=>\Wiki\Vendors\Helper\Data::PROFILE_FORM, 'title' => 'Test Tab 1','sort_order'=>20]
        );
        $setup->getConnection()->insertForce(
            $setup->getTable('ves_vendor_fieldset'),
            ['fieldset_id' => 3,'form'=>\Wiki\Vendors\Helper\Data::PROFILE_FORM, 'title' => 'Test Tab 2','sort_order'=>30]
        );
        
        /*Registration Form*/
        $setup->getConnection()->insertForce(
            $setup->getTable('ves_vendor_fieldset'),
            ['fieldset_id' => 4,'form'=>\Wiki\Vendors\Helper\Data::REGISTRATION_FORM, 'title' => 'General','sort_order'=>10]
        );
        
        $setup->getConnection()->insertForce(
            $setup->getTable('ves_vendor_fieldset'),
            ['fieldset_id' => 5,'form'=>\Wiki\Vendors\Helper\Data::REGISTRATION_FORM, 'title' => 'Test Tab 1','sort_order'=>20]
        );
        $setup->getConnection()->insertForce(
            $setup->getTable('ves_vendor_fieldset'),
            ['fieldset_id' => 6,'form'=>\Wiki\Vendors\Helper\Data::REGISTRATION_FORM, 'title' => 'Test Tab 2','sort_order'=>30]
        );
        ...
        $vendorSetup->addAttribute(
            ...
            [
                ...
                'type' => 'varchar',
                'input' => 'file',
                'backend' => 'Wiki\Vendors\Model\Entity\Attribute\Backend\File',
                'position' => 146,
                'visible' => true,
                'required' => false,
                'default' => 'jpg,png,gif',
        ...
        foreach ($attributes as $fieldsetId => $attrs) {
            foreach ($attrs as $attributeCode) {
                ...
                if (!in_array($attributeCode, ['firstname','lastname','email'])) {
                    $attribute = $om->create('Wiki\Vendors\Model\Attribute');
