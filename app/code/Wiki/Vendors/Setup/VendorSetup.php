...
class VendorSetup extends EavSetup
{
    ...
    public function getDefaultEntities()
    {
        $entities = [
            'vendor' => [
                'entity_model' => 'Wiki\Vendors\Model\ResourceModel\Vendor',
                'attribute_model' => 'Wiki\Vendors\Model\Attribute',
                ...
                'entity_attribute_collection' => 'Wiki\Vendors\Model\ResourceModel\Attribute\Collection',
                'attributes' => [
                    'vendor_id' => [
                        'type' => 'static',
                        'label' => 'Vendor Id',
                    ...
                    'group_id' => [
                        ...
                        'label' => 'Group',
                        'input' => 'select',
                        'source' => 'Wiki\Vendors\Model\Source\Group',
                        'required' => true,
                        'sort_order' => 60,
                        'position' => 40,
                        'used_in_profile_form' => 1,
                    ...
                    'status' => [
                        ...
                        'label' => 'Status',
                        'input' => 'select',
                        'source' => 'Wiki\Vendors\Model\Source\Status',
                        'required' => true,
                        'sort_order' => 60,
                        'position' => 50,
                        'used_in_profile_form' => 1,
