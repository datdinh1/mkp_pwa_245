 ...
 */
namespace Wiki\Vendors\Model\ResourceModel\Vendor\Grid;
...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    public function __construct(
        ...
        $resourceModel = 'Wiki\Vendors\Model\ResourceModel\Vendor';
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $mainTable, $resourceModel);
        $this->_eventManager->dispatch('Wiki_vendors_ui_accountdataprovider_collection_prepare', ['collection' => $this]);
    }
