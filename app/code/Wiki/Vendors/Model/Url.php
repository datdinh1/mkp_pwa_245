...
class Url extends \Magento\Backend\Model\Url implements \Wiki\Vendors\Model\UrlInterface
{
    /**
     ...
     * Menu config
     *
     * @var \Wiki\Vendors\Model\Menu\Config
     */
     ...
     * @param \Wiki\Vendors\Helper\Data $vendorBackendHelper
     * @param \Wiki\Vendors\Model\Menu\Config $vendorMenuConfig
     * @param array $data
     */
    public function __construct(
        ...
        \Wiki\Vendors\Helper\Data $vendorBackendHelper,
        \Wiki\Vendors\Model\Menu\Config $vendorMenuConfig,
        array $data = []
    ) {
    ...
    {
        $resolver = ObjectManager::getInstance()->get('Wiki\Vendors\App\Area\FrontNameResolver');
...
//     }
    ...
    public function getBaseUrl($params = []){
        if(!$this->_scopeConfig->getValue(\Wiki\Vendors\App\Area\FrontNameResolver::XML_PATH_USE_CUSTOM_VENDOR_URL)){
            return parent::getBaseUrl($params);
        }
        $customUrl = $this->_scopeConfig->getValue(\Wiki\Vendors\App\Area\FrontNameResolver::XML_PATH_CUSTOM_VENDOR_URL);
