...
class Vendor extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @param \Wiki\Vendors\Model\ResourceModel\Vendor $resource
    ...
    public function __construct(
        ...
        \Wiki\Vendors\Model\ResourceModel\Vendor $resource,
    ...
    {
        $this->_init('Wiki\Vendors\Model\ResourceModel\Vendor');
    }
    ...
    public function getGroup()
    {
        if (!$this->_vendor_group) {
            ...
            $this->_vendor_group = $om->create('Wiki\Vendors\Model\Group');
    ...
    public function getStatusLabel()
    {
        if (!$this->getData('status_label')) {
            $om = \Magento\Framework\App\ObjectManager::getInstance();
            $source = $om->create('Wiki\Vendors\Model\Source\Status');
     ...
     * Get Email Helper
     *
     * @return \Wiki\Vendors\Helper\Email
     */
    public function getEmailHelper()
    {
        if (!$this->_emailHelper) {
            $om = \Magento\Framework\App\ObjectManager::getInstance();
            $this->_emailHelper = $om->create('Wiki\Vendors\Helper\Email');
        }
