 ...
 */
namespace Wiki\Vendors\Model\Menu;
...
class Item extends \Magento\Backend\Model\Menu\Item
{
     ...
     * @param \Wiki\Vendors\Model\UrlInterface $vendorUrlModel
     * @param array $data
     */
    public function __construct(
        ...
        \Wiki\Vendors\Model\UrlInterface $vendorUrlModel,
    ...
    public function __wakeup()
    {
        ...
        $this->_vendorUrlModel = $objectManager->get('Wiki\Vendors\Model\UrlInterface');
