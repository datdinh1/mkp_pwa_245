<?php
namespace Wiki\Vendors\Block\Adminhtml\Vendor\Create\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    */
    ...
    protected function _prepareForm()
    {
        ...
        $website = $om->get('Wiki\Vendors\Model\Source\Website');
        $fieldset->addField(
            'website_id',
            'select',
            [
        ...
        /*
        $store = $om->get('Wiki\Vendors\Model\Source\Store');
        $fieldset->addField(
            'sendemail_store_id',
            'select',
            [
        ...
        $fieldset->addType('vendor_password', 'Wiki\Vendors\Block\Adminhtml\Form\Element\Password');
