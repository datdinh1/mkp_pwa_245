 ...
 */
namespace Wiki\Vendors\Block\Adminhtml\Attribute;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        return $this->getUrl('vendors/*/validate', ['_current' => true]);
    }
    ...
    public function getSaveUrl()
    {
        return $this->getUrl(
            'vendors/*/save',
            ['_current' => true, 'back' => null, 'active_tab' => $this->getRequest()->getParam('active_tab')]
        );
    }
}
