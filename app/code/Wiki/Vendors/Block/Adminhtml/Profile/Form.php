 ...
 */
namespace Wiki\Vendors\Block\Adminhtml\Profile;
...
class Form extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Fieldset collection
     * @var \Wiki\Vendors\Model\ResourceModel\Vendor\Fieldset\Collection
     */
    protected $_fieldsetCollection;
    
    /**
     * Vendor attribute collection
     * @var \Wiki\Vendors\Model\ResourceModel\Attribute\Collection
     */
     ...
     * @return \Wiki\Vendors\Block\Adminhtml\Profile\Form
     */
    protected function _initFieldsetCollection()
    {
        $this->_fieldsetCollection->addFieldToFilter('form', \Wiki\Vendors\Helper\Data::PROFILE_FORM);
     ...
     * @return \Wiki\Vendors\Model\ResourceModel\Vendor\Fieldset\Collection
     */
