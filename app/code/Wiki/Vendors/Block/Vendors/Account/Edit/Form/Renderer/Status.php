...
use \Wiki\Vendors\Model\Vendor as VendorClass;
 ...
 */
class Status extends \Wiki\Vendors\Block\Vendors\Widget\Form\Renderer\Fieldset\Element
{
    protected $_template = 'Wiki_Vendors::account/form/renderer/fieldset/status.phtml';

    /**
     * @var \Wiki\Vendors\Model\Source\Status
     */
    protected $_options;
    ...
    public function __construct(
        ...
        \Wiki\Vendors\Model\Source\Status $status,
        array $data = []
    ) {
