...
use Wiki\AutoRelatedProduct\Model\App;
...
class Tabs extends \Magento\Backend\Block\Template implements \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Wiki_Vendors::account/form/renderer/tabs.phtml';
    ...
    {
        $tabBlock = $this->getLayout()->createBlock('Wiki\Vendors\Block\Vendors\Account\Edit\Form\Tabs', 'tabs');
