...
namespace Wiki\Vendors\Block\Vendors\Account\Edit;
...
class Form extends \Wiki\Vendors\Block\Vendors\Widget\Form\Generic
{
     ...
     * @var string
     */
    protected $_template = 'Wiki_Vendors::account/form.phtml';
    /**
     * @return void
     */
    ...
    protected function _prepareForm()
    {
        ...
        $tabBlock = $this->getLayout()->createBlock('Wiki\Vendors\Block\Vendors\Account\Edit\Form\Renderer\Tabs', 'tabs_field');
