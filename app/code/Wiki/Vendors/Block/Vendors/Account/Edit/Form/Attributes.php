<?php
namespace Wiki\Vendors\Block\Vendors\Account\Edit\Form;

use Wiki\Vendors\Block\Vendors\Widget\Form;
...
class Attributes extends Generic
{
    ...
    /**
     * Region renderer
     * @var \Wiki\Vendors\Block\Vendors\Account\Edit\Form\Renderer\Region
     */
    ...
    */
    public function __construct(
        ...
        \Wiki\Vendors\Block\Vendors\Account\Edit\Form\Renderer\Region $regionRenderer,
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('file', 'Wiki\Vendors\Block\Vendors\Widget\Form\Element\File');
        $fieldset->addType('image', 'Wiki\Vendors\Block\Vendors\Widget\Form\Element\Image');
        $fieldset->addType('boolean', 'Wiki\Vendors\Block\Vendors\Widget\Form\Element\Boolean');
    ...
    {
        return [
            'vendor_id' => 'Wiki\Vendors\Block\Vendors\Account\Edit\Form\Renderer\Vendor',
            'group_id' => 'Wiki\Vendors\Block\Vendors\Account\Edit\Form\Renderer\Group',
            'status' => 'Wiki\Vendors\Block\Vendors\Account\Edit\Form\Renderer\Status',
        ];
    }
    ...
    protected function _applyTypeSpecificConfigCustomer(
        ...
        switch ($inputType) {
            ...
            case 'multiselect':
                ...
                break;
            case 'date':
                $element->setDateFormat('MM/dd/yyyy');
                break;
            case 'multiline':
