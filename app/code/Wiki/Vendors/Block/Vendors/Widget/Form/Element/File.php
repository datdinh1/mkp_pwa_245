<?php
namespace Wiki\Vendors\Block\Vendors\Widget\Form\Element;

class File extends \Wiki\Vendors\Block\Adminhtml\Form\Element\File
{
    /**
     * Adminhtml data
     *
     ...
     * @param \Wiki\Vendors\Helper\Data $vendorUrl
     * @param array $data
     */
    public function __construct(
        ...
        \Wiki\Vendors\Helper\Data $vendorUrl,
        $data = []
    ) {
        $this->_url = $vendorUrl;
