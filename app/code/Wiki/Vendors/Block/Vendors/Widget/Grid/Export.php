 ...
 */
class Export extends \Magento\Backend\Block\Widget implements \Wiki\Vendors\Block\Vendors\Widget\Grid\ExportInterface
{
    /**
     * Grid export types
     *
     ...
     * @var string
     */
    protected $_template = "Wiki_Vendors::widget/grid/export.phtml";
