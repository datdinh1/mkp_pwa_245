...
class Image extends \Magento\Catalog\Helper\Image
{
     ...
     * Image factory
     *
     * @var \Wiki\Vendors\Model\ImageFactory
     */
     ...
     * @param \Wiki\Vendors\Model\ImageFactory $imageFactory
     */
    public function __construct(
        ...
        \Wiki\Vendors\Model\ImageFactory $imageFactory
    ) {
     ...
     *
     * @param string $path
     * @return \Wiki\Vendors\Helper\Image
     */
     ...
     *
     * @return \Wiki\Vendors\Model\Image
     */
    ...
    public function getFrame()
    {
        ...
        if (empty($imageFrame)) {
            $imageFrame = $this->getConfigView()->getVarValue('Wiki_Vendors', 'image_white_borders');
        }
        return $imageFrame;
    }
