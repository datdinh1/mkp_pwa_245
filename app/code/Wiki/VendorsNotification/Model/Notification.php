<?php
namespace Wiki\VendorsNotification\Model;

class Notification extends \Magento\Framework\Model\AbstractModel
{

    const ENTITY = 'vendor_notification';
    const DEFAULT_NOTIFICATION_TYPE = 'Wiki\VendorsNotification\Model\Type\DefaultType';
    const NOTIFYCATION_ALL      = 0;
    const NOTIFYCATION_CUSTOMER = 1;
    const NOTIFYCATION_VENDOR   = 2;
    ...
    /**
     * @var \Wiki\VendorsNotification\Model\Type\TypeInterface
     */
    ...
    {
        $this->_init('Wiki\VendorsNotification\Model\ResourceModel\Notification');
    }
     ...
     *
     * @return \Wiki\VendorsNotification\Model\Type\TypeInterface
     */
