...
class Month implements LayoutProcessorInterface
{
    /**
    ...
    public function process($jsLayout)
    {
        ...
        $jsLayout['components']['reports']['graphs_data'][$dateRange['value']]['report_sales'] = [
            Period::PERIOD_MONTH => $this->_salesReport->getOrderTotalsByMonth(
                $from,
                $to,
                $vendorId
            ),
        ...
        $jsLayout['components']['reports']['report_url'] = $this->_url->getUrl('reports/sales_graph/month');
