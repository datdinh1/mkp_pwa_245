 ...
 */
namespace Wiki\VendorsProductDownloadable\Ui\DataProvider\Product\Form\Modifier;
...
class Links extends AbstractModifier
{
    ...
    protected function getFileColumn()
    {
        ...
        $fileTypeField['arguments']['data']['config'] = [
            ...
            'componentType' => Form\Field::NAME,
            'component' => 'Wiki_VendorsProductDownloadable/js/components/upload-type-handler',
            'dataType' => Form\Element\DataType\Text::NAME,
            'dataScope' => 'type',
        ...
        $fileUploader['arguments']['data']['config'] = [
            ...
            'component' => 'Wiki_VendorsProductDownloadable/js/components/file-uploader',
            'elementTmpl' => 'Wiki_VendorsProductDownloadable/components/file-uploader',
            'fileInputName' => 'links',
            'uploaderConfig' => [
                'url' => $this->urlBuilder->getUrl(
                    'catalog/downloadable_file/upload',
