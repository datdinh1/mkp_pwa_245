 ...
 */
namespace Wiki\Credit\Block\Adminhtml\Customer\Edit\Tab;
...
class Credit extends \Magento\Backend\Block\Template implements TabInterface
{
    ...
    protected function _prepareLayout(){
        $this->addChild('transaction_grid', 'Wiki\Credit\Block\Adminhtml\Customer\Edit\Tab\Credit\Transaction\Grid');
