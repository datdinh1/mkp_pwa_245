 ...
 */
namespace Wiki\Credit\Block\Adminhtml\Credit;
...
class Dashboard extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @param \Wiki\Credit\Model\CreditFactory $creditFactory
     * @param \Magento\Backend\Block\Template\Context $context
     * @param array $data
     */
    public function __construct(
        \Wiki\Credit\Model\CreditFactory $creditFactory,
    ...
    protected function _prepareLayout(){
        $this->addChild('transaction_grid', 'Wiki\Credit\Block\Adminhtml\Credit\Dashboard\Transaction\Grid');
    ...
    public function getCreditAccountUrl(){
        return $this->getUrl('vstorecredit/account');
    }
    ...
    public function getAllTransactionUrl(){
        return $this->getUrl('vstorecredit/transaction');
    }
