...
class CreditCustom extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    public function validate($object){
        ...
        if($object->getData('credit_type') !== \Wiki\Credit\Model\Source\Type::TYPE_RANGE) return;
        ...
        if($value && is_array($value)){
            ...
            return true;
        }elseif($object->getData('credit_type') == \Wiki\Credit\Model\Source\Type::TYPE_RANGE){
    ...
    public function beforeSave($object)
    {
        ...
        if($object->getData('credit_type') == \Wiki\Credit\Model\Source\Type::TYPE_RANGE){
            $value = $object->getData($attrCode);
            if($value && is_array($value)){
