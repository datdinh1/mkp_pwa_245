 ...
 */
namespace Wiki\Credit\Model\Product\Attribute\Backend;
...
class CreditDropdown extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    public function validate($object){
        ...
        if($object->getData('credit_type') !== \Wiki\Credit\Model\Source\Type::TYPE_OPTION) return;
        ...
        }elseif($object->getData('credit_type') == \Wiki\Credit\Model\Source\Type::TYPE_OPTION){
    ...
    public function beforeSave($object)
    {
        ...
        if($object->getData('credit_type') == \Wiki\Credit\Model\Source\Type::TYPE_OPTION){
            $value = $object->getData($attrCode);
            if($value && is_array($value)){
