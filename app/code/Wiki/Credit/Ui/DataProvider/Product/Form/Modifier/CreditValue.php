 ...
 */
namespace Wiki\Credit\Ui\DataProvider\Product\Form\Modifier;
...
class CreditValue extends AbstractModifier
{
     ...
     * Customize credit custom value field
     *
     * @return \Wiki\Credit\Ui\DataProvider\Product\Form\Modifier\CreditValue
     */
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Wiki_Credit/js/components/dynamic-rows',
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Wiki_Credit/js/components/group',
                        'imports' =>[
                            'handleCreditTypeChange' => '${$.provider}:data.product.credit_type'
                        ],
                    ],
    ...
    protected function getCreditRateStruct($fieldPath)
    {
        ...
        $defaultData['arguments']['data']['config']['component'] = 'Wiki_Credit/js/components/group';
