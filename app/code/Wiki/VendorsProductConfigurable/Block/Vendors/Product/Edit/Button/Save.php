 ...
 */
namespace Wiki\VendorsProductConfigurable\Block\Vendors\Product\Edit\Button;

use Magento\Ui\Component\Control\Container;
use Wiki\VendorsProduct\Block\Vendors\Product\Edit\Button\Generic as Generic;
...
class Save extends Generic
{
    ...
    protected function getOptions()
    {
        ...
        $helperData =  $om->create('Wiki\VendorsProduct\Helper\Data');
        if(
