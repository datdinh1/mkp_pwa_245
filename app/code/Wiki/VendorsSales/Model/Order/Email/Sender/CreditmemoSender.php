...
use Wiki\VendorsSales\Model\Order\Email\Container\CreditmemoIdentity;
...
class CreditmemoSender extends Sender
{
    ...
    public function send(Creditmemo $creditmemo, $forceSyncMode = false)
    {
        ...
        $vendorOrder = $this->_objectManager->create('Wiki\VendorsSales\Model\Order')->load($creditmemo->getVendorOrderId());
