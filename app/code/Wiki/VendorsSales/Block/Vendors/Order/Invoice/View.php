...
namespace Wiki\VendorsSales\Block\Vendors\Order\Invoice;
...
class View extends \Wiki\Vendors\Block\Vendors\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction(
            'Wiki_VendorsSales::sales_order_action_cancel'
        ...
        if ($this->_isAllowedAction('Wiki_VendorsSales::sales_order_action_creditmemo') && $this->getInvoice()->getOrder()->canCreditmemo()) {
        ...
        if ($this->_isAllowedAction(
            'Wiki_VendorsSales::sales_order_action_capture'
