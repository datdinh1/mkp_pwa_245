 ...
 */
namespace Wiki\VendorsSales\Block\Vendors\Order;
...
class View extends \Wiki\Vendors\Block\Vendors\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Wiki_VendorsSales';
...
//         if ($this->_isAllowedAction('Wiki_VendorsSales::actions_edit') && $order->canEdit()) {
...
//         }
        ...
        if ($this->_isAllowedAction('Wiki_VendorsSales::sales_order_action_cancel') && $vendorOrder->canCancel()) {
            $this->buttonList->add(
                'order_cancel',
                [
                    'label' => __('Cancel'),
...
//         if ($this->_isAllowedAction('Wiki_VendorsSales::emails') && !$order->isCanceled()) {
...
//         }
        ...
        if ($this->_isAllowedAction('Wiki_VendorsSales::sales_order_action_creditmemo') && $vendorOrder->canCreditmemo()) {
            $message = __(
        ...
        if ($this->_isAllowedAction('Wiki_VendorsSales::sales_order_action_invoice') && $vendorOrder->canInvoice()) {
        ...
        if ($this->_isAllowedAction(
            'Wiki_VendorsSales::sales_order_action_ship'
