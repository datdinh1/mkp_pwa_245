...
class Save extends \Magento\Backend\App\Action
{
     ...
     * @param \Wiki\VendorsSales\Controller\Adminhtml\Sales\Creditmemo\CreditmemoLoader $creditmemoLoader
     * @param CreditmemoSender $creditmemoSender
     * @param \Magento\Backend\Model\View\Result\ForwardFactory $resultForwardFactory
     */
    public function __construct(
        Action\Context $context,
        \Wiki\VendorsSales\Controller\Adminhtml\Sales\Creditmemo\CreditmemoLoader $creditmemoLoader,
    ...
    public function execute()
    {
        ...
        try {
            $vendorOrder = $this->_objectManager->create('Wiki\VendorsSales\Model\Order')->load($this->getRequest()->getParam('vorder_id'));
            ...
            if ($creditmemo) {
                ...
                $this->_eventManager->dispatch(
                    'Wiki_vendorssales_order_creditmemo_save_after',
