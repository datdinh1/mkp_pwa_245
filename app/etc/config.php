...
return [
    'modules' => [
        ...
        'Swissup_Core' => 1,
        'Swissup_PwaStudioIntegration' => 1,
        'Swissup_UpwardConnector' => 1,
        'Temando_ShippingRemover' => 1,
        'Wiki_CmsGraphQl' => 1,
        'Wiki_Core' => 1,
        'Wiki_Credit' => 1,
        'Wiki_OtpSms' => 1,
        'Wiki_SampleImageUploader' => 1,
        'Wiki_SmTheme' => 1,
        'Wiki_SmsNotification' => 1,
        'Wiki_StoreApi' => 1,
        'Wiki_VAT' => 1,
        'Wiki_Vendors' => 1,
        'Wiki_VendorsAcl' => 1,
        'Wiki_VendorsApi' => 1,
        'Wiki_VendorsAuction' => 1,
        'Wiki_VendorsChat' => 1,
        'Wiki_VendorsCommission' => 1,
        'Wiki_VendorsCommissionPreview' => 1,
        'Wiki_VendorsConfig' => 1,
        'Wiki_VendorsNotification' => 1,
        'Wiki_VendorsSales' => 1,
        'Wiki_VendorsCredit' => 1,
        'Wiki_VendorsCustomRegister' => 1,
        'Wiki_VendorsMedia' => 1,
        'Wiki_VendorsCustomWithdrawal' => 1,
        'Wiki_VendorsCustomerAccount' => 1,
        'Wiki_VendorsDashboard' => 1,
        'Wiki_VendorsFaq' => 1,
        'Wiki_VendorsFollow' => 1,
        'Wiki_VendorsImportExport' => 1,
        'Wiki_VendorsLanguage' => 1,
        'Wiki_VendorsPage' => 1,
        'Wiki_VendorsCustomTheme' => 1,
        'Wiki_VendorsConfigApproval' => 1,
        'Wiki_VendorsLayerNavigation' => 1,
        'Wiki_VendorsProduct' => 1,
        'Wiki_VendorsProductBundle' => 1,
        'Wiki_VendorsProductConfigurable' => 1,
        'Wiki_VendorsProductDownloadable' => 1,
        'Wiki_VendorsProductGrouped' => 1,
        'Wiki_VendorsProfile' => 1,
        'Wiki_VendorsProfileNotification' => 1,
        'Wiki_VendorsReport' => 1,
        'Wiki_VendorsCoupon' => 1,
        'Wiki_VendorsSalesRule' => 1,
        'Wiki_VendorsSubAccount' => 1,
        'Wiki_VendorsUi' => 1,
