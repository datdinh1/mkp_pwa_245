-- Magento DB backup
--
-- Host: localhost    Database: bestMagento
-- ------------------------------------------------------
...
--
-- Table structure for table `Wiki_faq_detail`
--

DROP TABLE IF EXISTS `Wiki_faq_detail`;
CREATE TABLE `Wiki_faq_detail` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `faq_id` int unsigned NOT NULL COMMENT 'Faq Id',
  `question` text NOT NULL COMMENT 'Question',
  `answer` text NOT NULL COMMENT 'Question',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Wiki_faq_detail';

--
-- Table structure for table `Wiki_sampleimageuploader_image`
--

DROP TABLE IF EXISTS `Wiki_sampleimageuploader_image`;
CREATE TABLE `Wiki_sampleimageuploader_image` (
  `image_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Image ID',
  `title` varchar(255) NOT NULL COMMENT 'Title',
  `image` varchar(255) NOT NULL COMMENT 'Image',
  `category_id` int DEFAULT NULL,
  PRIMARY KEY (`image_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Wiki_sampleimageuploader_image';
...
INSERT INTO `admin_passwords` VALUES ('1','1','aefd1adcade072396089274c3d6e0cf927e222cacbfe18109c9b822c355e9801:m39i1LmwYuQkLmUmgxqL9oAy3qWT2qLO:3_32_2_67108864','0','1663753033'),('2','1','68486fe868d435b61bcb624407dc346995cc8105c76ab26b13e29581823bd5e6:H2DB548rA0sU2IUnchFmSpW4bJpGTiuR:3_32_2_67108864','0','1663815618');
...
INSERT INTO `admin_system_messages` VALUES ('da332d712f3215b9b94bfa268c398323',2,'2022-09-21 10:50:13');
...
INSERT INTO `admin_user` VALUES ('1','admin','admin','user@example.com','admin','68486fe868d435b61bcb624407dc346995cc8105c76ab26b13e29581823bd5e6:H2DB548rA0sU2IUnchFmSpW4bJpGTiuR:3_32_2_67108864','2022-09-21 09:37:13','2022-09-22 07:00:43','2022-09-22 07:00:43',5,0,1,'{\"configState\":{\"web_upward\":\"1\"}}',NULL,NULL,'en_US',0,NULL,NULL);
...
INSERT INTO `admin_user_session` VALUES ('1',NULL,'1',1,'2022-09-21 10:45:39','2022-09-21 10:52:02','127.0.0.1'),('2',NULL,'1',1,'2022-09-22 03:24:41','2022-09-22 03:45:28','127.0.0.1'),('3',NULL,'1',1,'2022-09-22 04:09:59','2022-09-22 04:37:20','127.0.0.1'),('4',NULL,'1',2,'2022-09-22 06:46:11','2022-09-22 07:00:43','127.0.0.1'),('5',NULL,'1',1,'2022-09-22 07:00:43','2022-09-22 07:15:39','127.0.0.1');
...
INSERT INTO `adminnotification_inbox` VALUES ('1',4,'2022-09-21 09:37:11','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0);
...
INSERT INTO `captcha_log` VALUES ('2','asdas@gmail.com','1','2022-09-22 03:40:27'),('2','da@gmail.com','1','2022-09-22 06:45:18'),('2','dasd@gmail.com','1','2022-09-22 07:01:05'),('2','QWe123@gmail.com','1','2022-09-22 06:53:16'),('2','qweqwe@gmail.com','1','2022-09-22 06:57:30');
/*!40000 ALTER TABLE `captcha_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cart_multiple_shop`
--

DROP TABLE IF EXISTS `cart_multiple_shop`;
CREATE TABLE `cart_multiple_shop` (
  `card_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Card_id',
  `customer_id` varchar(20) DEFAULT NULL COMMENT 'Customer_id',
  `product` text COMMENT 'Product',
  PRIMARY KEY (`card_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='cart_multiple_shop';
...
INSERT INTO `catalog_category_entity` VALUES ('1',3,'0','2022-09-21 09:37:09','2022-09-21 09:37:10','1','0','0','1'),('2',3,'1','2022-09-21 09:37:10','2022-09-21 09:37:10','1/2','1','1','0');
...
CREATE TABLE `catalog_product_entity` (
  ...
  `vendor_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Id',
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb3 COMMENT='Config Data';
...
INSERT INTO `core_config_data` VALUES ('1','default','0','web/seo/use_rewrites','1','2022-09-21 09:36:52'),('2','default','0','web/unsecure/base_url','http://dev.bestmagento.abc/','2022-09-22 06:51:16'),('3','default','0','general/locale/code','en_US','2022-09-21 09:36:52'),('4','default','0','general/locale/timezone','America/Chicago','2022-09-21 09:36:53'),('5','default','0','currency/options/base','USD','2022-09-21 09:36:53'),('6','default','0','currency/options/default','USD','2022-09-21 09:36:53'),('7','default','0','currency/options/allow','USD','2022-09-21 09:36:53'),('8','default','0','general/region/display_all','1','2022-09-21 09:36:54'),('9','default','0','general/region/state_required','AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,US,UY,VE','2022-09-21 09:37:07'),('10','default','0','catalog/category/root_id','2','2022-09-21 09:37:10'),('11','default','0','analytics/subscription/enabled','1','2022-09-21 09:37:11'),('12','default','0','crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2022-09-21 09:37:11'),('13','default','0','crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2022-09-21 09:37:11'),('14','default','0','msp_securitysuite_recaptcha/frontend/enabled','0','2022-09-21 09:37:12'),('15','default','0','msp_securitysuite_recaptcha/backend/enabled','0','2022-09-21 09:37:12'),('16','default','0','twofactorauth/duo/application_key','n6HLs7eqgxEaLJXlCCpdJ4E4YDPgbOLfjatoBpWvPFgKnrGMiefkxdNst1C0NcJy','2022-09-21 09:37:12'),('17','default','0','admin/usage/enabled','1','2022-09-21 10:52:06'),('18','default','0','system/backup/functionality_enabled','1','2022-09-22 03:02:02');
...
INSERT INTO `customer_eav_attribute_website` VALUES (1,1,NULL,NULL,NULL,NULL),(3,1,NULL,NULL,NULL,NULL),(5,1,NULL,NULL,NULL,NULL),(6,1,NULL,NULL,NULL,NULL),(7,1,NULL,NULL,NULL,NULL),(9,1,NULL,NULL,NULL,NULL),(10,1,NULL,NULL,NULL,NULL),(11,1,NULL,NULL,NULL,NULL),(17,1,NULL,NULL,NULL,NULL),(18,1,NULL,NULL,NULL,NULL),(19,1,NULL,NULL,NULL,NULL),(20,1,NULL,NULL,NULL,NULL),(21,1,NULL,NULL,NULL,NULL),(23,1,NULL,NULL,NULL,NULL),(24,1,NULL,NULL,NULL,NULL),(25,1,NULL,NULL,NULL,NULL),(27,1,NULL,NULL,NULL,NULL),(28,1,NULL,NULL,NULL,NULL),(29,1,NULL,NULL,NULL,NULL),(30,1,NULL,NULL,NULL,NULL),(31,1,NULL,NULL,NULL,NULL),(32,1,NULL,NULL,NULL,NULL),(33,1,NULL,NULL,NULL,NULL),(34,1,NULL,NULL,NULL,NULL),(35,1,NULL,NULL,NULL,NULL),(36,1,NULL,NULL,NULL,NULL),(144,1,NULL,NULL,NULL,NULL),(160,1,NULL,NULL,NULL,NULL),(161,1,NULL,NULL,NULL,NULL),(162,1,NULL,NULL,NULL,NULL),(163,1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `customer_entity` (
  ...
  `mobile` text COMMENT 'Phone Number Of Customer.',
...
INSERT INTO `customer_entity` VALUES ('1',1,'datdinh@gmail.com','',1,NULL,1,'2022-09-21 10:53:03','2022-09-21 10:53:03',1,0,'Default Store View',NULL,'customer',NULL,'customer',NULL,NULL,'9aee5b42450b5d31f5ebf01078a77e88da9a982b5b7f4cb5598626f4b147d4e0:yTOTWQmmSkJDHvooZ03tcRyJFienErTg:3_32_2_67108864','0:3:sg3z2hviXWK4DYkKsQH/jQ/avRsJVKREjRIXVnHjKulVUGVRYao/2fNh9oJdlTUOzwcl53vdFJbrmvYH','2022-09-21 10:53:03',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL),('2',1,'datdinh123@gmail.com','',1,NULL,1,'2022-09-22 03:41:07','2022-09-22 03:41:08',1,0,'Default Store View',NULL,'customer',NULL,'customer',NULL,NULL,'fa0fd5eb7cfa497028dd04e72aefd2b68d6c9e8820db3284b258c2c06eaf8ca0:6qLs8G6NXrHBWV7JeoaiRASKthmrHufZ:3_32_2_67108864','0:3:WWs1dLog0sY0TJ9pP4NtH0YOVYrab6DbI4vXNmV21033k/yqkG2eb+3bL4DmlkX6rUppVA6j0WDati2y','2022-09-22 03:41:08',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='Customer Entity Int';
...
INSERT INTO `customer_entity_int` VALUES ('1',144,'1','0'),('3',144,'2','0');
...
INSERT INTO `customer_grid_flat` VALUES ('1','customer customer','datdinh@gmail.com','1','2022-09-21 10:53:03','1',NULL,'Default Store View',NULL,NULL,NULL,NULL,'','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('2','customer customer','datdinh123@gmail.com','1','2022-09-22 03:41:07','1',NULL,'Default Store View',NULL,NULL,NULL,NULL,'','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='Customer Log Table';
...
INSERT INTO `customer_log` VALUES ('1','1','2022-09-21 10:53:09',NULL),('2','2','2022-09-22 07:01:14',NULL);
...
INSERT INTO `customer_visitor` VALUES (1,'1',NULL,'2022-09-21 10:53:02','2022-09-21 10:53:10'),(2,'2',NULL,'2022-09-22 03:40:27','2022-09-22 03:43:54'),(3,'2',NULL,'2022-09-22 06:45:18','2022-09-22 06:45:27'),(4,'2',NULL,'2022-09-22 06:52:52','2022-09-22 06:52:53'),(5,NULL,NULL,'2022-09-22 06:53:16','2022-09-22 06:53:16'),(6,'2',NULL,'2022-09-22 06:53:34','2022-09-22 06:53:34'),(7,NULL,NULL,'2022-09-22 06:57:30','2022-09-22 06:57:30'),(8,'2',NULL,'2022-09-22 07:01:05','2022-09-22 07:01:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=185 DEFAULT CHARSET=utf8mb3 COMMENT='Eav Attribute';
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb3 COMMENT='Eav Attribute Group';
...
INSERT INTO `eav_attribute_group` VALUES (1,1,'General',1,1,'general',NULL),(2,2,'General',1,1,'general',NULL),(3,3,'General',10,1,'general',NULL),(4,3,'General Information',2,0,'general-information',NULL),(5,3,'Display Settings',20,0,'display-settings',NULL),(6,3,'Custom Design',30,0,'custom-design',NULL),(7,4,'Product Details',10,1,'product-details','basic'),(8,4,'Advanced Pricing',40,0,'advanced-pricing','advanced'),(9,4,'Search Engine Optimization',30,0,'search-engine-optimization','basic'),(10,4,'Images',20,0,'image-management','basic'),(11,4,'Design',50,0,'design','advanced'),(12,4,'Autosettings',60,0,'autosettings','advanced'),(13,4,'Content',15,0,'content','basic'),(14,4,'Schedule Design Update',55,0,'schedule-design-update','advanced'),(15,5,'General',1,1,'general',NULL),(16,6,'General',1,1,'general',NULL),(17,7,'General',1,1,'general',NULL),(18,8,'General',1,1,'general',NULL),(19,4,'Bundle Items',16,0,'bundle-items',NULL),(20,4,'Gift Options',61,0,'gift-options',NULL),(21,3,'MGS Megamenu',31,0,'mgs-megamenu',NULL),(22,3,'Content',32,0,'content',NULL),(23,9,'General',1,1,'general',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb3 COMMENT='Eav Attribute Option';
...
INSERT INTO `eav_attribute_option` VALUES ('1',20,0),('2',20,1),('3',20,3),('4',179,0),('5',179,1),('6',179,2),('7',179,3),('8',180,0),('9',180,1),('10',180,2),('11',180,3);
...
INSERT INTO `eav_attribute_option_value` VALUES ('1','1',0,'Male'),('2','2',0,'Female'),('3','3',0,'Not Specified'),('4','4',0,'Test option 1'),('5','5',0,'Test option 2'),('6','6',0,'Test option 3'),('7','7',0,'Test option 4'),('8','8',0,'Option 1'),('9','9',0,'Option 2'),('10','10',0,'Option 3'),('11','11',0,'Option 4');
...
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8mb3 COMMENT='Eav Entity Attributes';
...
INSERT INTO `eav_entity_store` VALUES ('1',9,0,'0','000000001');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='Eav Entity Type';
...
INSERT INTO `flag` VALUES ('1','analytics_link_attempts_reverse_counter',0,'24','2022-09-21 09:37:11'),('2','catalog_website_attribute_is_sync_required',0,'2','2022-09-21 10:04:04'),('3','config_hash',0,'{\"system\":\"2be88ca4242c76e8253ac62474851065032d6833\"}','2022-09-22 03:02:03');
...
INSERT INTO `indexer_state` VALUES ('1','design_config_grid','valid','2022-09-22 06:54:27','0fc60d66caf0bf8eae84a6bfec6a0a45'),('2','customer_grid','valid','2022-09-22 03:00:17','c8c2822c7acbf2b1a277ac608616d0ff'),('3','catalog_category_product','invalid','2022-09-22 02:58:30','528b8a277f1c9c6dfc9415bdd8db5ee7'),('4','catalog_product_category','invalid','2022-09-22 02:58:30','8ac170f64996f15c22c3bf52392c4eb5'),('5','catalogrule_rule','invalid','2022-09-22 02:58:30','1ff3b674007e2de50bbbfb73b36ff298'),('6','catalog_product_attribute','invalid','2022-09-22 02:58:30','ffaab078606cbe47516e522da41a562c'),('7','cataloginventory_stock','invalid','2022-09-22 02:58:30','3fc0a9d174ff29db8a63d339e5a104cf'),('8','inventory','invalid','2022-09-22 02:58:30','c994347020fb72157792ae46210d9c33'),('9','catalogrule_product','invalid','2022-09-22 02:58:30','1c7792b6ed82b5ed23ee8cf19e97244e'),('10','catalog_product_price','invalid','2022-09-22 02:58:30','11283ad7dfb921099c2015db1cd9642a'),('11','catalogsearch_fulltext','invalid','2022-09-22 02:58:30','185ab886cc07bc35db4f82421af2fc91');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Categories';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Category Post';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Category Store';
...
CREATE TABLE `mgs_blog_comment` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  `status` smallint NOT NULL DEFAULT '2' COMMENT 'Status',
  PRIMARY KEY (`comment_id`),
  KEY `MGS_BLOG_COMMENT_EMAIL` (`email`),
  FULLTEXT KEY `MGS_BLOG_COMMENT_NAME_EMAIL_CONTENT` (`name`,`email`,`content`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Comments';
...
CREATE TABLE `mgs_blog_post` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  `thumb_type` varchar(50) DEFAULT '' COMMENT 'Thumbnail Type',
  `video_thumb_type` varchar(50) DEFAULT '' COMMENT 'Video Thumbnail Type',
  `image` varchar(150) DEFAULT '' COMMENT 'Image',
  `video_thumb_id` varchar(50) DEFAULT '' COMMENT 'Video Thumbnail Id',
  `image_type` varchar(50) DEFAULT '' COMMENT 'Image Type',
  `video_big_type` varchar(50) DEFAULT '' COMMENT 'Video Base Type',
  `video_big_id` varchar(50) DEFAULT '' COMMENT 'Video Base Id',
  `author_post` smallint DEFAULT '0' COMMENT 'Author Post',
  PRIMARY KEY (`post_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Posts';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Post Store';
...
CREATE TABLE `mgs_blog_tag` (
  ...
  `tag_count` int NOT NULL DEFAULT '0' COMMENT 'Tag Count',
  `store_id` smallint unsigned NOT NULL COMMENT 'Store Id',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  PRIMARY KEY (`tag_id`),
  FULLTEXT KEY `MGS_BLOG_TAG_TAG` (`tag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Blog Tags';
...
CREATE TABLE `mgs_brand` (
  `brand_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Brand Id',
  `name` varchar(250) NOT NULL COMMENT 'Name',
  `url_key` varchar(250) NOT NULL COMMENT 'Url Key',
  ...
  `meta_description` text COMMENT 'Meta Description',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  `is_featured` smallint NOT NULL DEFAULT '0' COMMENT 'Featured Brand',
  `sort_order` int NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  `option_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Option Id',
  PRIMARY KEY (`brand_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Brands';

--
-- Table structure for table `mgs_brand_category`
--

DROP TABLE IF EXISTS `mgs_brand_category`;
CREATE TABLE `mgs_brand_category` (
  `brand_id` int unsigned NOT NULL COMMENT 'Brand Id',
  `category_id` int unsigned NOT NULL COMMENT 'Category Id',
  KEY `MGS_BRAND_CATEGORY_CATEGORY_ID` (`category_id`),
  KEY `MGS_BRAND_CATEGORY_BRAND_ID_MGS_BRAND_BRAND_ID` (`brand_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='MGS Brand Category Match';
...
CREATE TABLE `mgs_brand_product` (
  ...
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Products of Brand';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Brands of Store';

--
-- Table structure for table `mgs_lookbook`
--

DROP TABLE IF EXISTS `mgs_lookbook`;
CREATE TABLE `mgs_lookbook` (
  `lookbook_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Lookbook Id',
  `name` varchar(255) NOT NULL DEFAULT '' COMMENT 'Name',
  `image` varchar(255) NOT NULL DEFAULT '' COMMENT 'Image',
  `pins` mediumtext COMMENT 'Pins info',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  PRIMARY KEY (`lookbook_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_lookbook';

--
-- Table structure for table `mgs_lookbook_slide`
--

DROP TABLE IF EXISTS `mgs_lookbook_slide`;
CREATE TABLE `mgs_lookbook_slide` (
  `slide_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Slider Id',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  `custom_class` varchar(255) NOT NULL DEFAULT '' COMMENT 'Custom Class',
  `auto_play` smallint NOT NULL DEFAULT '1' COMMENT 'Autoplay',
  `auto_play_timeout` varchar(255) NOT NULL DEFAULT '' COMMENT 'Autoplay Timeout',
  `stop_auto` smallint NOT NULL DEFAULT '1' COMMENT 'Stop autopaly when mouseover',
  `navigation` smallint NOT NULL DEFAULT '1' COMMENT 'Show Navigation',
  `pagination` smallint NOT NULL DEFAULT '1' COMMENT 'Show Pagination',
  `loop` smallint NOT NULL DEFAULT '1' COMMENT 'Loop',
  `next_image` varchar(255) NOT NULL DEFAULT '' COMMENT 'Next Icon',
  `prev_image` varchar(255) NOT NULL DEFAULT '' COMMENT 'Previous Icon',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  PRIMARY KEY (`slide_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_lookbook_slide';

--
-- Table structure for table `mgs_lookbook_slide_items`
--

DROP TABLE IF EXISTS `mgs_lookbook_slide_items`;
CREATE TABLE `mgs_lookbook_slide_items` (
  `item_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id',
  `slide_id` int NOT NULL COMMENT 'Slider ID',
  `lookbook_id` int NOT NULL COMMENT 'Lookbook ID',
  `position` int NOT NULL DEFAULT '0' COMMENT 'Position',
  PRIMARY KEY (`item_id`,`slide_id`,`lookbook_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_lookbook_slide_items';
...
CREATE TABLE `mgs_megamenu` (
  `megamenu_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Megamenu Id',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  `menu_type` smallint NOT NULL DEFAULT '1' COMMENT 'Menu types',
  ...
  `columns` smallint NOT NULL DEFAULT '0' COMMENT 'Columns',
  ...
  `max_level` smallint DEFAULT NULL COMMENT 'Max level of sub category',
  `dropdown_position` smallint NOT NULL DEFAULT '1' COMMENT 'Dropdown Position',
  `use_thumbnail` smallint NOT NULL DEFAULT '2' COMMENT 'Thumbnail of category',
  ...
  `left_col` smallint DEFAULT NULL COMMENT 'columns of left',
  `right_content` mediumtext COMMENT 'Right content',
  `right_col` smallint DEFAULT NULL COMMENT 'columns of right',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  ...
  `store` int NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `html_label` varchar(255) DEFAULT NULL COMMENT 'Html label',
  PRIMARY KEY (`megamenu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_megamenu';
...
CREATE TABLE `mgs_megamenu_cache` (
  `cache_id` smallint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Cache ID',
  `parent_id` int NOT NULL DEFAULT '0' COMMENT 'Parent Id',
  `store_id` smallint unsigned NOT NULL COMMENT 'Store ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='Menu Log';
...
INSERT INTO `mgs_megamenu_cache` VALUES (1,'1',1,'      \r\n\r\n					<nav class=\"navigation\" role=\"navigation\">\r\n		<ul id=\"mainMenu\" class=\"nav nav-main nav-main-menu\">\r\n					</ul>\r\n	</nav>\r\n','2022-09-22 02:37:59');
...
CREATE TABLE `mgs_megamenu_parent` (
  `parent_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Parent Id',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  `menu_type` smallint NOT NULL DEFAULT '1' COMMENT 'Menu types',
  `custom_class` varchar(255) DEFAULT NULL COMMENT 'Custom class',
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Status',
  PRIMARY KEY (`parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='mgs_megamenu_parent';
...
CREATE TABLE `mgs_megamenu_store` (
  `megamenu_id` int NOT NULL COMMENT 'Megamenu ID',
  `store_id` int unsigned NOT NULL COMMENT 'Store ID',
  PRIMARY KEY (`megamenu_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_megamenu_store';
...
CREATE TABLE `mgs_portfolio_category` (
  ...
  PRIMARY KEY (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_portfolio_category';
...
CREATE TABLE `mgs_portfolio_category_items` (
  ...
  `portfolio_id` int NOT NULL COMMENT 'Portfolio Id',
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_portfolio_category_items';
...
CREATE TABLE `mgs_portfolio_items` (
  `portfolio_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Portfolio Id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
  `identifier` varchar(255) DEFAULT NULL COMMENT 'Identifier',
  ...
  `status` smallint NOT NULL DEFAULT '1' COMMENT 'Is Active',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_portfolio_items';

--
-- Table structure for table `mgs_protabs`
--

DROP TABLE IF EXISTS `mgs_protabs`;
CREATE TABLE `mgs_protabs` (
  `tab_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Protabs Id',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  `tab_type` varchar(255) DEFAULT NULL COMMENT 'Type',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  `position` int DEFAULT NULL COMMENT 'Position',
  `scope` varchar(8) DEFAULT NULL COMMENT 'Scope',
  `scope_id` int NOT NULL DEFAULT '0' COMMENT 'Scope Id',
  PRIMARY KEY (`tab_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COMMENT='mgs_protabs';

--
-- Dumping data for table `mgs_protabs`
--

LOCK TABLES `mgs_protabs` WRITE;
/*!40000 ALTER TABLE `mgs_protabs` DISABLE KEYS */;
INSERT INTO `mgs_protabs` VALUES ('1','Details','attribute','description','1','default','0'),('2','More Information','product.attributes','','2','default','0'),('3','Reviews','reviews.tab','','3','default','0');
/*!40000 ALTER TABLE `mgs_protabs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mgs_theme_catagory_setting`
--

DROP TABLE IF EXISTS `mgs_theme_catagory_setting`;
CREATE TABLE `mgs_theme_catagory_setting` (
  `category_id` int unsigned NOT NULL COMMENT 'Id',
  `ratio` smallint DEFAULT NULL COMMENT 'Product Picture Ratio',
  `desc_position` smallint DEFAULT NULL COMMENT 'Description Position',
  `number_product_on_row` smallint DEFAULT NULL COMMENT 'Number Of Poduct On A Row',
  PRIMARY KEY (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_theme_catagory_setting';

--
-- Table structure for table `mgs_theme_home_block_childs`
--

DROP TABLE IF EXISTS `mgs_theme_home_block_childs`;
CREATE TABLE `mgs_theme_home_block_childs` (
  `child_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `page_id` int DEFAULT NULL COMMENT 'CMS Page Id',
  `block_name` varchar(255) DEFAULT NULL COMMENT 'Block Name',
  `home_name` varchar(255) DEFAULT NULL COMMENT 'Home Name',
  `type` varchar(255) DEFAULT NULL COMMENT 'Block Type',
  `position` int DEFAULT NULL COMMENT 'Block Position',
  `setting` mediumtext COMMENT 'Block Setting',
  `col` smallint DEFAULT NULL COMMENT 'Columns',
  `class` varchar(255) DEFAULT NULL COMMENT 'Block Class',
  `store_id` int NOT NULL COMMENT 'Store View Id',
  `static_block_id` int NOT NULL COMMENT 'Static Block Id',
  `block_content` mediumtext COMMENT 'Block Short Code',
  PRIMARY KEY (`child_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_theme_home_block_childs';

--
-- Table structure for table `mgs_theme_home_blocks`
--

DROP TABLE IF EXISTS `mgs_theme_home_blocks`;
CREATE TABLE `mgs_theme_home_blocks` (
  `block_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Block Id',
  `page_id` int DEFAULT NULL COMMENT 'CMS Page Id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Block Name',
  `theme_name` varchar(255) DEFAULT NULL COMMENT 'Theme Name',
  `block_cols` varchar(255) DEFAULT NULL COMMENT 'Block Columns',
  `tablet_cols` varchar(255) DEFAULT NULL COMMENT 'Table columns',
  `mobile_cols` varchar(255) DEFAULT NULL COMMENT 'Mobile columns',
  `block_class` varchar(255) DEFAULT NULL COMMENT 'Block Class',
  `class` varchar(255) DEFAULT NULL COMMENT 'Class',
  `background` varchar(255) DEFAULT NULL COMMENT 'Section Background Color',
  `background_image` varchar(255) DEFAULT NULL COMMENT 'Section Background Image',
  `background_repeat` smallint DEFAULT NULL COMMENT 'Background Repeat',
  `background_cover` smallint DEFAULT NULL COMMENT 'Background Cover',
  `parallax` smallint DEFAULT NULL COMMENT 'Background Parallax',
  `fullwidth` smallint DEFAULT NULL COMMENT 'Section Full Width',
  `padding_top` varchar(255) DEFAULT NULL COMMENT 'Padding Top',
  `padding_bottom` varchar(255) DEFAULT NULL COMMENT 'Padding Bottom',
  `store_id` int NOT NULL COMMENT 'Store View Id',
  `block_position` int DEFAULT NULL COMMENT 'Block Position',
  PRIMARY KEY (`block_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_theme_home_blocks';

--
-- Table structure for table `mgs_theme_home_store`
--

DROP TABLE IF EXISTS `mgs_theme_home_store`;
CREATE TABLE `mgs_theme_home_store` (
  `home_store_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `store_id` int NOT NULL COMMENT 'Store View Id',
  `status` smallint DEFAULT NULL COMMENT 'Status',
  PRIMARY KEY (`home_store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='mgs_theme_home_store';
...
CREATE TABLE `promobanners` (
  `promobanners_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Promobanners Id',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='promobanners';
...
INSERT INTO `queue_poison_pill` VALUES ('version-632bd02b4ed23');
...
CREATE TABLE `quote` (
  ...
  `credit_amount` decimal(12,4) NOT NULL COMMENT 'Used credit',
  `base_credit_amount` decimal(12,4) NOT NULL COMMENT 'Used credit',
  `applied_vendor_coupon_ids` varchar(255) DEFAULT NULL COMMENT 'Applied Vendor Coupon Ids',
  `vendor_discount_detail` text COMMENT 'Vendor Discount Detail',
  PRIMARY KEY (`entity_id`),
...
INSERT INTO `quote` VALUES ('1',1,'2022-09-21 10:53:09','2022-09-21 10:53:09',NULL,1,0,0,'0','0.0000','0','0.0000','0.0000','USD','USD','USD','0.0000','0.0000',NULL,'1',NULL,'1','datdinh@gmail.com',NULL,'customer',NULL,'customer',NULL,NULL,NULL,1,0,'127.0.0.1',NULL,NULL,NULL,NULL,'USD','1.0000','1.0000',NULL,NULL,'0.0000','0.0000','0.0000','0.0000','1',0,NULL,NULL,0,'0.0000','0.0000',NULL,NULL),('2',1,'2022-09-22 03:41:09','2022-09-22 03:41:09',NULL,1,0,0,'0','0.0000','0','0.0000','0.0000','USD','USD','USD','0.0000','0.0000',NULL,'2',NULL,'1','datdinh123@gmail.com',NULL,'customer',NULL,'customer',NULL,NULL,NULL,1,0,'127.0.0.1',NULL,NULL,NULL,NULL,'USD','1.0000','1.0000',NULL,NULL,'0.0000','0.0000','0.0000','0.0000','1',0,NULL,NULL,0,'0.0000','0.0000',NULL,NULL);
...
CREATE TABLE `quote_address` (
  ...
  `credit_amount` decimal(12,4) NOT NULL COMMENT 'Credit Amount',
  `base_credit_amount` decimal(12,4) NOT NULL COMMENT 'Base Credit Amount',
  ...
  `sub_district` varchar(255) DEFAULT NULL COMMENT 'Sub District',
  PRIMARY KEY (`address_id`),
...
INSERT INTO `quote_address` VALUES ('1','1','2022-09-21 10:53:09','2022-09-21 10:53:09','1',0,NULL,'billing','datdinh@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,'0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',NULL,'null',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),('2','1','2022-09-21 10:53:09','2022-09-21 10:53:09','1',0,NULL,'shipping','datdinh@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,NULL,NULL,'0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',NULL,'null',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),('3','2','2022-09-22 03:41:09','2022-09-22 03:41:09','2',0,NULL,'billing','datdinh123@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,'0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',NULL,'null',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),('4','2','2022-09-22 03:41:09','2022-09-22 03:41:09','2',0,NULL,'shipping','datdinh123@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,NULL,NULL,'0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',NULL,'null',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000','0.0000',NULL,'0.0000','0.0000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL);
...
CREATE TABLE `quote_item` (
  ...
  `weight` decimal(12,4) DEFAULT '0.0000' COMMENT 'Weight',
  `weight_unit` varchar(12) DEFAULT NULL COMMENT 'Weight Unit',
  `size_unit` varchar(12) DEFAULT NULL COMMENT 'Size Unit',
  `qty` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Qty',
...
CREATE TABLE `sales_creditmemo` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `vendor_order_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Id',
  `store_id` smallint unsigned DEFAULT NULL COMMENT 'Store ID',
  ...
  `base_credit_refunded` decimal(12,4) NOT NULL COMMENT ' Refunded to Store Credit ',
  `credit_refunded` decimal(12,4) NOT NULL COMMENT ' Refunded to Store Credit ',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `sales_invoice_item` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `vendor_invoice_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Id',
  `parent_id` int unsigned NOT NULL COMMENT 'Parent ID',
  `base_price` decimal(12,4) DEFAULT NULL COMMENT 'Base Price',
  `tax_amount` decimal(12,4) DEFAULT NULL COMMENT 'Tax Amount',
  ...
  `base_weee_tax_disposition` decimal(12,4) DEFAULT NULL COMMENT 'Base Weee Tax Disposition',
  `base_weee_tax_row_disposition` decimal(12,4) DEFAULT NULL COMMENT 'Base Weee Tax Row Disposition',
  `commission` decimal(12,4) DEFAULT NULL COMMENT 'Commission',
  `commission_description` text COMMENT 'Commission description',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `sales_order` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `time_to_receive` varchar(32) DEFAULT NULL COMMENT 'Time To Receive',
  `state` varchar(32) DEFAULT NULL COMMENT 'State',
  `status` varchar(32) DEFAULT NULL COMMENT 'Status',
  `wk_status` varchar(32) DEFAULT NULL COMMENT 'Wiki Status',
  `time_expand` smallint DEFAULT NULL COMMENT 'Time Expand',
  `coupon_code` varchar(255) DEFAULT NULL COMMENT 'Coupon Code',
...
CREATE TABLE `sales_order_item` (
  ...
  `vendor_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Id',
  `vendor_order_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Order Id',
  `parent_item_id` int unsigned DEFAULT NULL COMMENT 'Parent Item ID',
  ...
  `credit_invoiced` decimal(12,4) NOT NULL COMMENT 'Used credit',
  `base_credit_invoiced` decimal(12,4) NOT NULL COMMENT 'Used credit',
  ...
  `base_tax_refunded` decimal(20,4) DEFAULT NULL COMMENT 'Base Tax Refunded',
  `discount_refunded` decimal(20,4) DEFAULT NULL COMMENT 'Discount Refunded',
  `credit_refunded` decimal(12,4) NOT NULL COMMENT 'Used credit',
  `base_discount_refunded` decimal(20,4) DEFAULT NULL COMMENT 'Base Discount Refunded',
  `base_credit_refunded` decimal(12,4) NOT NULL COMMENT 'Used credit',
  `gift_message_id` int DEFAULT NULL COMMENT 'Gift Message ID',
...
CREATE TABLE `sales_order_status_history` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `parent_id` int unsigned NOT NULL COMMENT 'Parent ID',
  `vendor_id` decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Id',
  `is_customer_notified` int DEFAULT NULL COMMENT 'Is Customer Notified',
  `is_visible_on_front` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Is Visible On Front',
  `comment` text COMMENT 'Comment',
  `status` varchar(32) DEFAULT NULL COMMENT 'Status',
  `vendor_order_status` decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Statuc Order',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
...
CREATE TABLE `salesrule` (
  ...
  `is_visible_in_listing` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Is Visible In Listing',
  `image` text COMMENT 'Default of image is change',
  `coupon_by_seller` text COMMENT 'Default of coupon by seller is change',
  `type` text COMMENT 'All products or Some Products',
  `is_recommend` smallint DEFAULT '0' COMMENT 'Is Recommend',
  `is_display_all` smallint DEFAULT '0' COMMENT 'Show all coupon',
  `max_discount_amount` int DEFAULT '0' COMMENT 'Max Discount Amount',
  `minimum_price` int DEFAULT '0' COMMENT 'Minimum Price',
  `category_id` int DEFAULT '0' COMMENT 'Category Id',
  PRIMARY KEY (`rule_id`),
...
CREATE TABLE `salesrule_coupon` (
  ...
  `auto_generate` text COMMENT 'Auto Generate',
...
INSERT INTO `setup_module` VALUES ('Magento_GoogleShoppingAds','4.0.1','4.0.1'),('Magento_Securitytxt','1.0.0','1.0.0'),('MGS_AjaxCart','2.0.0','2.0.0'),('MGS_Ajaxlayernavigation','1.0.0','1.0.0'),('MGS_Blog','2.0.1','2.0.1'),('MGS_Brand','2.0.1','2.0.1'),('MGS_GDPR','1.0.0','1.0.0'),('MGS_Guestwishlist','1.0.0','1.0.0'),('MGS_InstantSearch','2.0.0','2.0.0'),('MGS_Lookbook','1.0.0','1.0.0'),('MGS_Mmegamenu','1.0.2','1.0.2'),('MGS_Mpanel','1.1.0','1.1.0'),('MGS_Portfolio','1.0.0.0','1.0.0.0'),('MGS_Promobanners','1.0.0.1','1.0.0.1'),('MGS_Protabs','1.0.0','1.0.0'),('MGS_QuickView','2.0.0','2.0.0'),('MGS_Social','2.0.0','2.0.0'),('MGS_StoreLocator','0.0.3','0.0.3'),('MGS_Testimonial','1.0.0.0','1.0.0.0'),('PayPal_Braintree','4.4.0','4.4.0'),('Wiki_CatalogGraphQl','2.2.10','2.2.10'),('Wiki_CmsGraphQl','2.2.10','2.2.10'),('Wiki_Core','2.0.0','2.0.0'),('Wiki_Credit','2.0.2','2.0.2'),('Wiki_OtpSms','1.0.1','1.0.1'),('Wiki_SampleImageUploader','1.0.7','1.0.7'),('Wiki_SmsNotification','1.0.2','1.0.2'),('Wiki_SmTheme','2.0.0','2.0.0'),('Wiki_StoreApi','1.0.5','1.0.5'),('Wiki_VAT','1.0.1','1.0.1'),('Wiki_Vendors','2.2.10','2.2.10'),('Wiki_VendorsAcl','2.0.0','2.0.0'),('Wiki_VendorsApi','2.0.0','2.0.0'),('Wiki_VendorsChat','0.0.9','0.0.9'),('Wiki_VendorsCommission','2.0.0','2.0.0'),('Wiki_VendorsCommissionPreview','2.0.0','2.0.0'),('Wiki_VendorsConfig','2.0.1','2.0.1'),('Wiki_VendorsConfigApproval','2.0.1','2.0.1'),('Wiki_VendorsCoupon','1.0.7','1.0.7'),('Wiki_VendorsCredit','2.1.0','2.1.0'),('Wiki_VendorsCustomerAccount','1.0.1','1.0.1'),('Wiki_VendorsCustomRegister','2.0.2','2.0.2'),('Wiki_VendorsCustomTheme','2.0.0','2.0.0'),('Wiki_VendorsCustomWithdrawal','2.0.0','2.0.0'),('Wiki_VendorsDashboard','2.0.1','2.0.1'),('Wiki_VendorsFaq','0.0.1','0.0.1'),('Wiki_VendorsFollow','1.0.0','1.0.0'),('Wiki_VendorsImportExport','2.0.0','2.0.0'),('Wiki_VendorsLanguage','2.0.0','2.0.0'),('Wiki_VendorsLayerNavigation','2.0.1','2.0.1'),('Wiki_VendorsMedia','2.0.0','2.0.0'),('Wiki_VendorsNotification','2.0.5','2.0.5'),('Wiki_VendorsPage','2.0.2','2.0.2'),('Wiki_VendorsProduct','2.0.4','2.0.4'),('Wiki_VendorsProductBundle','2.0.0','2.0.0'),('Wiki_VendorsProductConfigurable','2.0.1','2.0.1'),('Wiki_VendorsProductDownloadable','2.0.0','2.0.0'),('Wiki_VendorsProductGrouped','2.0.0','2.0.0'),('Wiki_VendorsProfile','1.0.0','1.0.0'),('Wiki_VendorsProfileNotification','2.0.0','2.0.0'),('Wiki_VendorsReport','2.0.1','2.0.1'),('Wiki_VendorsSales','2.1.3','2.1.3'),('Wiki_VendorsSalesRule','0.1.0','0.1.0'),('Wiki_VendorsSubAccount','2.0.0','2.0.0'),('Wiki_VendorsUi','2.0.0.0','2.0.0.0'),('Wiki_Wishlist','1.0.0','1.0.0'),('Yireo_DisableServiceWorkerInAdmin','0.0.1','0.0.1');
...
INSERT INTO `store` VALUES (0,'admin',0,0,'Admin',0,1),(1,'default',1,1,'Default Store View',0,1),(2,'vendors',0,0,'Vendor Panel',0,1);
...
CREATE TABLE `store_locator` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Store Locator Id',
...
CREATE TABLE `store_locator_store` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Store Locator Store Id',
  `storelocator_id` int unsigned NOT NULL COMMENT 'Store Locator Id',
  `store_id` smallint unsigned NOT NULL COMMENT 'Store Id',
  PRIMARY KEY (`id`),
  KEY `STORE_LOCATOR_STORE_STORELOCATOR_ID` (`storelocator_id`),
  KEY `STORE_LOCATOR_STORE_STORE_ID` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Store Locators Store';
...
CREATE TABLE `testimonial` (
  `testimonial_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Testimonial Id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='testimonial';
...
INSERT INTO `theme` VALUES ('1',NULL,'Magento/blank','Magento Blank','preview_image_632adb4379d43.jpeg',0,'frontend',0,'Magento/blank'),('2',NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),('3','1','Magento/luma','Magento Luma','preview_image_632adb4395d3e.jpeg',0,'frontend',0,'Magento/luma'),('4',NULL,'Wiki/vendor','Marketplace Theme',NULL,0,'vendors',0,'Wiki/vendor');
...
INSERT INTO `ui_bookmark` VALUES ('1','1','vendor_account_listing','default',1,'Default View','{\"views\":{\"default\":{\"label\":\"Default View\",\"index\":\"default\",\"editable\":false,\"data\":{\"columns\":{\"entity_id\":{\"visible\":true,\"sorting\":\"asc\"},\"vendor_id\":{\"visible\":true,\"sorting\":false},\"firstname\":{\"visible\":true,\"sorting\":false},\"lastname\":{\"visible\":true,\"sorting\":false},\"email\":{\"visible\":true,\"sorting\":false},\"telephone\":{\"visible\":true,\"sorting\":false},\"postcode\":{\"visible\":true,\"sorting\":false},\"actions\":{\"visible\":true,\"sorting\":false},\"ids\":{\"visible\":true,\"sorting\":false},\"status\":{\"visible\":true,\"sorting\":false},\"group_id\":{\"visible\":true,\"sorting\":false},\"country_id\":{\"visible\":true,\"sorting\":false},\"web_id\":{\"visible\":true,\"sorting\":false},\"credit\":{\"visible\":true,\"sorting\":false}},\"filters\":{\"applied\":{\"placeholder\":true}},\"paging\":{\"pageSize\":20,\"current\":1,\"options\":{\"20\":{\"value\":20,\"label\":20},\"30\":{\"value\":30,\"label\":30},\"50\":{\"value\":50,\"label\":50},\"100\":{\"value\":100,\"label\":100},\"200\":{\"value\":200,\"label\":200}},\"value\":20},\"displayMode\":\"grid\",\"positions\":{\"ids\":0,\"entity_id\":1,\"vendor_id\":2,\"firstname\":3,\"lastname\":4,\"group_id\":5,\"telephone\":6,\"email\":7,\"postcode\":8,\"web_id\":9,\"country_id\":10,\"credit\":11,\"status\":12,\"actions\":13}},\"value\":\"Default View\"}}}','2022-09-22 03:45:48','2022-09-22 03:45:48'),('2','1','vendor_account_listing','current',0,NULL,'{\"current\":{\"columns\":{\"entity_id\":{\"visible\":true,\"sorting\":\"asc\"},\"vendor_id\":{\"visible\":true,\"sorting\":false},\"firstname\":{\"visible\":true,\"sorting\":false},\"lastname\":{\"visible\":true,\"sorting\":false},\"email\":{\"visible\":true,\"sorting\":false},\"telephone\":{\"visible\":true,\"sorting\":false},\"postcode\":{\"visible\":true,\"sorting\":false},\"actions\":{\"visible\":true,\"sorting\":false},\"ids\":{\"visible\":true,\"sorting\":false},\"status\":{\"visible\":true,\"sorting\":false},\"group_id\":{\"visible\":true,\"sorting\":false},\"country_id\":{\"visible\":true,\"sorting\":false},\"web_id\":{\"visible\":true,\"sorting\":false},\"credit\":{\"visible\":true,\"sorting\":false}},\"filters\":{\"applied\":{\"placeholder\":true}},\"paging\":{\"pageSize\":20,\"current\":1,\"options\":{\"20\":{\"value\":20,\"label\":20},\"30\":{\"value\":30,\"label\":30},\"50\":{\"value\":50,\"label\":50},\"100\":{\"value\":100,\"label\":100},\"200\":{\"value\":200,\"label\":200}},\"value\":20},\"displayMode\":\"grid\",\"positions\":{\"ids\":0,\"entity_id\":1,\"vendor_id\":2,\"firstname\":3,\"lastname\":4,\"group_id\":5,\"telephone\":6,\"email\":7,\"postcode\":8,\"web_id\":9,\"country_id\":10,\"credit\":11,\"status\":12,\"actions\":13}}}','2022-09-22 03:45:49','2022-09-22 03:45:49');
...
--
-- Table structure for table `ves_core_licensekey`
--

DROP TABLE IF EXISTS `ves_core_licensekey`;
CREATE TABLE `ves_core_licensekey` (
  `key_id` smallint NOT NULL AUTO_INCREMENT COMMENT 'Key ID',
  `license_key` varchar(255) NOT NULL COMMENT 'License Key',
  `license_info` text NOT NULL COMMENT 'License Info',
  `additional_nfo` text COMMENT 'Description',
  PRIMARY KEY (`key_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='ves_core_licensekey';

--
-- Table structure for table `ves_store_credit`
--

DROP TABLE IF EXISTS `ves_store_credit`;
CREATE TABLE `ves_store_credit` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `customer_id` int unsigned NOT NULL COMMENT 'Customer Id',
  `credit` decimal(12,4) DEFAULT NULL COMMENT 'Store Credit',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `VES_STORE_CREDIT_CUSTOMER_ID` (`customer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Store Credit Table';

--
-- Dumping data for table `ves_store_credit`
--

LOCK TABLES `ves_store_credit` WRITE;
/*!40000 ALTER TABLE `ves_store_credit` DISABLE KEYS */;
INSERT INTO `ves_store_credit` VALUES ('1','1','0.0000'),('2','2','0.0000');
/*!40000 ALTER TABLE `ves_store_credit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_store_credit_transaction`
--

DROP TABLE IF EXISTS `ves_store_credit_transaction`;
CREATE TABLE `ves_store_credit_transaction` (
  `transaction_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Transaction Id',
  `customer_id` int unsigned NOT NULL COMMENT 'Customer Id',
  `type` varchar(32) DEFAULT NULL COMMENT 'Transaction Type',
  `amount` decimal(12,4) DEFAULT NULL COMMENT 'Transaction amount',
  `balance` decimal(12,4) DEFAULT NULL COMMENT 'Balance',
  `description` text COMMENT 'Description',
  `additional_info` text COMMENT 'Additional Info',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Created At',
  PRIMARY KEY (`transaction_id`),
  KEY `VES_STORE_CREDIT_TRANSACTION_CSTR_ID_VES_STORE_CREDIT_CSTR_ID` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Store Credit Transaction Table';

--
-- Table structure for table `ves_vendor_commission_rule`
--

DROP TABLE IF EXISTS `ves_vendor_commission_rule`;
CREATE TABLE `ves_vendor_commission_rule` (
  ...
  `is_active` smallint DEFAULT NULL COMMENT 'Is Active',
  `condition_serialized` mediumtext COMMENT 'Condition Serialized',
  `stop_rules_processing` smallint DEFAULT NULL COMMENT 'Stop further rules processing',
  `priority` int DEFAULT NULL COMMENT 'Prioirity',
  `commission_by` varchar(32) DEFAULT NULL COMMENT 'Commission By',
  `commission_action` varchar(32) DEFAULT NULL COMMENT 'Commission Action',
  `commission_amount` decimal(12,4) DEFAULT NULL COMMENT 'Commission Acmount',
  PRIMARY KEY (`rule_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Commission Table';

--
-- Table structure for table `ves_vendor_config`
--

DROP TABLE IF EXISTS `ves_vendor_config`;
CREATE TABLE `ves_vendor_config` (
  `config_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `vendor_id` int unsigned NOT NULL COMMENT 'Vendor Id',
  `store_id` smallint NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `path` varchar(255) DEFAULT NULL COMMENT 'Config Path',
  `value` longtext COMMENT 'Config Value',
  PRIMARY KEY (`config_id`),
  KEY `VES_VENDOR_CONFIG_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Config Table';

--
-- Dumping data for table `ves_vendor_config`
--

LOCK TABLES `ves_vendor_config` WRITE;
/*!40000 ALTER TABLE `ves_vendor_config` DISABLE KEYS */;
INSERT INTO `ves_vendor_config` VALUES ('1','1',0,'general/store_information/name',NULL),('2','1',0,'general/store_information/detail_store',NULL),('3','1',0,'general/store_information/short_description',NULL),('4','1',0,'general/store_information/phone',NULL),('5','1',0,'general/store_information/hours',NULL),('6','1',0,'general/store_information/cover_image_seller','Screenshot_from_2022-09-03_11-13-52.png'),('7','1',0,'general/store_information/logo_image_seller','Screenshot_from_2022-09-12_13-08-04.png'),('8','1',0,'general/store_information/favicon_icon_seller','Screenshot_from_2022-09-19_21-54-24.png'),('9','1',0,'general/store_information/logo','Screenshot_from_2022-09-21_22-11-09.png'),('10','1',0,'general/locale/code',NULL);
/*!40000 ALTER TABLE `ves_vendor_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_config_update`
--

DROP TABLE IF EXISTS `ves_vendor_config_update`;
CREATE TABLE `ves_vendor_config_update` (
  `update_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  ...
  KEY `VES_VENDOR_CONFIG_UPDATE_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Config Update Table';

--
-- Table structure for table `ves_vendor_coupon`
--

DROP TABLE IF EXISTS `ves_vendor_coupon`;
CREATE TABLE `ves_vendor_coupon` (
  `coupon_id` smallint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Coupon Id',
  `vendor_id` int unsigned NOT NULL COMMENT 'Vendor Id',
  `code` varchar(255) DEFAULT NULL COMMENT 'Coupon Code',
  `amount` decimal(12,4) unsigned NOT NULL DEFAULT '0.0000' COMMENT 'Discount Amount',
  `usage_limit` int unsigned NOT NULL DEFAULT '0' COMMENT 'Usage Limit',
  `usage_per_customer` int unsigned NOT NULL DEFAULT '0' COMMENT 'Usage per Customer',
  `times_used` int unsigned NOT NULL DEFAULT '0' COMMENT 'Times Used',
  `created_at` timestamp NOT NULL COMMENT 'Created At',
  `from_date` date DEFAULT NULL COMMENT 'From Date',
  `to_date` date DEFAULT NULL COMMENT 'To Date',
  `image` text NOT NULL COMMENT 'Image Coupon',
  PRIMARY KEY (`coupon_id`),
  UNIQUE KEY `VES_VENDOR_COUPON_VENDOR_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Store Coupon Table';

--
-- Table structure for table `ves_vendor_eav_attribute`
--

DROP TABLE IF EXISTS `ves_vendor_eav_attribute`;
CREATE TABLE `ves_vendor_eav_attribute` (
  ...
  `validate_rules` text COMMENT 'Validate Rules',
  `is_system` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Is System',
  `is_used_in_profile_form` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Is Used in Profile Form',
  `is_used_in_registration_form` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Is Used in Registration Form',
  `hide_from_vendor_panel` smallint DEFAULT '0' COMMENT 'Hide Attribute From Vendor Panel',
  `sort_order` int unsigned NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  `data_model` varchar(255) DEFAULT NULL COMMENT 'Data Model',
  PRIMARY KEY (`attribute_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Eav Attribute';

--
-- Dumping data for table `ves_vendor_eav_attribute`
--

LOCK TABLES `ves_vendor_eav_attribute` WRITE;
/*!40000 ALTER TABLE `ves_vendor_eav_attribute` DISABLE KEYS */;
INSERT INTO `ves_vendor_eav_attribute` VALUES (164,1,NULL,0,NULL,1,1,1,0,'30',NULL),(165,0,NULL,0,NULL,0,0,0,0,'0',NULL),(166,0,NULL,0,NULL,0,0,0,0,'0',NULL),(167,1,NULL,0,NULL,1,1,0,0,'40',NULL),(168,1,NULL,0,NULL,1,1,0,0,'50',NULL),(169,1,NULL,0,'a:2:{s:15:\"max_text_length\";i:255;s:15:\"min_text_length\";i:1;}',1,1,1,0,'60',NULL),(170,1,NULL,2,'a:2:{s:15:\"max_text_length\";i:255;s:15:\"min_text_length\";i:1;}',1,1,1,0,'70',NULL),(171,1,NULL,0,'a:2:{s:15:\"max_text_length\";i:255;s:15:\"min_text_length\";i:1;}',1,1,1,0,'80',NULL),(172,1,NULL,0,NULL,1,1,1,0,'90',NULL),(173,1,NULL,0,NULL,1,1,1,0,'100',NULL),(174,1,NULL,0,NULL,1,1,1,0,'100',NULL),(175,1,NULL,0,'a:0:{}',1,1,1,0,'110','Magento\\Customer\\Model\\Attribute\\Data\\Postcode'),(176,1,NULL,0,'a:2:{s:15:\"max_text_length\";i:255;s:15:\"min_text_length\";i:1;}',1,1,1,0,'120',NULL),(177,1,NULL,0,'a:2:{s:15:\"max_text_length\";i:255;s:15:\"min_text_length\";i:1;}',1,1,1,0,'130',NULL),(178,1,NULL,0,NULL,0,1,1,0,'145',NULL),(179,1,NULL,0,NULL,0,1,1,0,'146',NULL),(180,1,NULL,0,NULL,0,1,1,0,'146',NULL),(181,1,NULL,0,NULL,0,1,1,0,'146',NULL),(182,1,NULL,0,NULL,1,0,0,0,'40',NULL);
/*!40000 ALTER TABLE `ves_vendor_eav_attribute` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_entity`
--

DROP TABLE IF EXISTS `ves_vendor_entity`;
CREATE TABLE `ves_vendor_entity` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `website_id` smallint unsigned DEFAULT NULL COMMENT 'Website Id',
  `increment_id` varchar(50) DEFAULT NULL COMMENT 'Increment Id',
  `vendor_id` varchar(255) DEFAULT NULL COMMENT 'Vendor Id',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  `group_id` smallint unsigned NOT NULL DEFAULT '1' COMMENT 'Vendor Group Id',
  `status` smallint unsigned NOT NULL DEFAULT '1' COMMENT 'Status',
  `is_novice` smallint NOT NULL DEFAULT '1' COMMENT 'Novice Seller',
  `city` varchar(255) NOT NULL COMMENT 'City',
  `company` varchar(255) DEFAULT NULL COMMENT 'Company',
  `country_id` varchar(255) NOT NULL COMMENT 'Country',
  `fax` varchar(255) DEFAULT NULL COMMENT 'Fax',
  ...
  `street` text NOT NULL COMMENT 'Street Address',
  `telephone` varchar(255) NOT NULL COMMENT 'Phone Number',
  `main_address` int unsigned DEFAULT NULL COMMENT 'Main Address.',
  `shipping_address` int unsigned DEFAULT NULL COMMENT 'Shipping Address.',
  `return_address` int unsigned DEFAULT NULL COMMENT 'Return Address.',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `VES_VENDOR_ENTITY_VENDOR_ID_WEBSITE_ID` (`vendor_id`,`website_id`),
  KEY `VES_VENDOR_ENTITY_WEBSITE_ID_STORE_WEBSITE_WEBSITE_ID` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity';

--
-- Dumping data for table `ves_vendor_entity`
--

LOCK TABLES `ves_vendor_entity` WRITE;
/*!40000 ALTER TABLE `ves_vendor_entity` DISABLE KEYS */;
INSERT INTO `ves_vendor_entity` VALUES ('1',NULL,'000000001','asdaqwe22','2022-09-22 03:43:54','2022-09-22 04:10:27',1,2,1,'เกาะลันตา','company','VN',NULL,'81150',NULL,NULL,'address','',NULL,NULL,NULL);
/*!40000 ALTER TABLE `ves_vendor_entity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_entity_datetime`
--

DROP TABLE IF EXISTS `ves_vendor_entity_datetime`;
CREATE TABLE `ves_vendor_entity_datetime` (
  ...
  `value` datetime DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VES_VENDOR_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `VES_VENDOR_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VES_VENDOR_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity Datetime';

--
-- Table structure for table `ves_vendor_entity_decimal`
--

DROP TABLE IF EXISTS `ves_vendor_entity_decimal`;
CREATE TABLE `ves_vendor_entity_decimal` (
  `value_id` int NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `attribute_id` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VES_VENDOR_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `VES_VENDOR_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VES_VENDOR_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity Decimal';

--
-- Table structure for table `ves_vendor_entity_int`
--

DROP TABLE IF EXISTS `ves_vendor_entity_int`;
CREATE TABLE `ves_vendor_entity_int` (
  ...
  `value` int NOT NULL DEFAULT '0' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VES_VENDOR_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `VES_VENDOR_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VES_VENDOR_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity Int';

--
-- Dumping data for table `ves_vendor_entity_int`
--

LOCK TABLES `ves_vendor_entity_int` WRITE;
/*!40000 ALTER TABLE `ves_vendor_entity_int` DISABLE KEYS */;
INSERT INTO `ves_vendor_entity_int` VALUES ('1',182,'1','1');
/*!40000 ALTER TABLE `ves_vendor_entity_int` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_entity_text`
--

DROP TABLE IF EXISTS `ves_vendor_entity_text`;
CREATE TABLE `ves_vendor_entity_text` (
  ...
  `value` text NOT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VES_VENDOR_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `VES_VENDOR_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity Text';

--
-- Table structure for table `ves_vendor_entity_varchar`
--

DROP TABLE IF EXISTS `ves_vendor_entity_varchar`;
CREATE TABLE `ves_vendor_entity_varchar` (
  ...
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `VES_VENDOR_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `VES_VENDOR_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `VES_VENDOR_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity Varchar';

--
-- Dumping data for table `ves_vendor_entity_varchar`
--

LOCK TABLES `ves_vendor_entity_varchar` WRITE;
/*!40000 ALTER TABLE `ves_vendor_entity_varchar` DISABLE KEYS */;
INSERT INTO `ves_vendor_entity_varchar` VALUES ('1',181,'1',NULL);
/*!40000 ALTER TABLE `ves_vendor_entity_varchar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_escrow`
--

DROP TABLE IF EXISTS `ves_vendor_escrow`;
CREATE TABLE `ves_vendor_escrow` (
  `escrow_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Withdrawal Id',
  `vendor_id` int unsigned DEFAULT NULL COMMENT 'Vendor Id',
  `relation_id` int unsigned DEFAULT NULL COMMENT 'Invoice Id',
  `amount` decimal(12,4) DEFAULT NULL COMMENT 'Amount',
  `additional_info` longtext COMMENT 'Additional Info',
  `status` smallint unsigned DEFAULT NULL COMMENT 'Status',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  PRIMARY KEY (`escrow_id`),
  KEY `VES_VENDOR_ESCROW_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Escrow';

--
-- Table structure for table `ves_vendor_fieldset`
--

DROP TABLE IF EXISTS `ves_vendor_fieldset`;
CREATE TABLE `ves_vendor_fieldset` (
  `fieldset_id` smallint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Fieldset ID',
  `form` varchar(32) NOT NULL COMMENT 'Form',
  `title` varchar(128) NOT NULL COMMENT 'Fieldset Title',
  `sort_order` int unsigned NOT NULL COMMENT 'Sort Order',
  PRIMARY KEY (`fieldset_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Fieldset';

--
-- Dumping data for table `ves_vendor_fieldset`
--

LOCK TABLES `ves_vendor_fieldset` WRITE;
/*!40000 ALTER TABLE `ves_vendor_fieldset` DISABLE KEYS */;
INSERT INTO `ves_vendor_fieldset` VALUES (1,'profile_form','General','10'),(2,'profile_form','Test Tab 1','20'),(3,'profile_form','Test Tab 2','30'),(4,'registration_form','General','10'),(5,'registration_form','Test Tab 1','20'),(6,'registration_form','Test Tab 2','30');
/*!40000 ALTER TABLE `ves_vendor_fieldset` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_fieldset_attr`
--

DROP TABLE IF EXISTS `ves_vendor_fieldset_attr`;
CREATE TABLE `ves_vendor_fieldset_attr` (
  `fieldset_id` smallint unsigned NOT NULL COMMENT 'Fieldset Id',
  `attribute_id` smallint unsigned NOT NULL COMMENT 'Fieldset Id',
  `sort_order` int unsigned NOT NULL COMMENT 'Sort Order',
  KEY `VENDOR_FIELDSET_ATTR_FIELDSET_ID_VENDOR_FIELDSET_FIELDSET_ID` (`fieldset_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Fieldset Attribute';

--
-- Dumping data for table `ves_vendor_fieldset_attr`
--

LOCK TABLES `ves_vendor_fieldset_attr` WRITE;
/*!40000 ALTER TABLE `ves_vendor_fieldset_attr` DISABLE KEYS */;
INSERT INTO `ves_vendor_fieldset_attr` VALUES (1,164,'1'),(1,167,'2'),(1,168,'3'),(1,169,'4'),(1,170,'5'),(1,171,'6'),(1,172,'7'),(1,173,'8'),(1,174,'9'),(1,175,'10'),(1,176,'11'),(2,178,'12'),(2,179,'13'),(3,180,'14'),(3,181,'15'),(4,164,'16'),(4,169,'17'),(4,170,'18'),(4,171,'19'),(4,172,'20'),(4,173,'21'),(4,174,'22'),(4,175,'23'),(4,176,'24'),(5,178,'25'),(5,179,'26'),(6,180,'27'),(6,181,'28');
/*!40000 ALTER TABLE `ves_vendor_fieldset_attr` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_group`
--

DROP TABLE IF EXISTS `ves_vendor_group`;
CREATE TABLE `ves_vendor_group` (
  `vendor_group_id` smallint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Customer Group Id',
  `vendor_group_code` varchar(32) NOT NULL COMMENT 'Vendor Group Code',
  PRIMARY KEY (`vendor_group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Group';

--
-- Dumping data for table `ves_vendor_group`
--

LOCK TABLES `ves_vendor_group` WRITE;
/*!40000 ALTER TABLE `ves_vendor_group` DISABLE KEYS */;
INSERT INTO `ves_vendor_group` VALUES (1,'Default');
/*!40000 ALTER TABLE `ves_vendor_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_notification`
--

DROP TABLE IF EXISTS `ves_vendor_notification`;
CREATE TABLE `ves_vendor_notification` (
  `notification_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `vendor_id` int unsigned DEFAULT NULL COMMENT 'Vendor Id',
  `type` varchar(32) NOT NULL COMMENT 'Notification Type',
  `message` varchar(255) NOT NULL COMMENT 'Title',
  `additional_info` varchar(128) NOT NULL COMMENT 'Additional info to build the URL',
  `is_read` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Is Read',
  `is_reached` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Is reached',
  `is_hidden` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Is reached',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `customer_id` int DEFAULT NULL,
  `noti_admin_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Admin Notification ID',
  `content` text NOT NULL COMMENT 'Content cancel Order',
  `notification_of` smallint unsigned NOT NULL DEFAULT '0' COMMENT '0 - All, 1 - Customers, 2 - Vendors',
  `image` varchar(255) DEFAULT NULL COMMENT 'Image',
  PRIMARY KEY (`notification_id`),
  KEY `VES_VENDOR_NOTIFICATION_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor notificaiton';

--
-- Table structure for table `ves_vendor_product_attribute_group`
--

DROP TABLE IF EXISTS `ves_vendor_product_attribute_group`;
CREATE TABLE `ves_vendor_product_attribute_group` (
  `group_id` smallint unsigned NOT NULL AUTO_INCREMENT COMMENT 'group Id',
  `attribute_set_id` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Set Id',
  `name` varchar(255) NOT NULL DEFAULT '' COMMENT 'Name',
  `sort_order` smallint DEFAULT NULL COMMENT 'Sort Order',
  PRIMARY KEY (`group_id`),
  KEY `FK_E59566E2E3546C51ED5ECC8BF47F5F18` (`attribute_set_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Attribute group';

--
-- Table structure for table `ves_vendor_product_attribute_set`
--

DROP TABLE IF EXISTS `ves_vendor_product_attribute_set`;
CREATE TABLE `ves_vendor_product_attribute_set` (
  `attribute_set_id` smallint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_set_id` smallint unsigned NOT NULL COMMENT 'Parent Attribute Set Id',
  `display_type` varchar(32) DEFAULT NULL COMMENT 'Display groups type',
  `attribute_set_name` varchar(255) DEFAULT NULL COMMENT 'Attribute Set Name',
  `sort_order` smallint DEFAULT NULL COMMENT 'Sort Order',
  PRIMARY KEY (`attribute_set_id`),
  KEY `VES_VENDOR_PRD_ATTR_SET_PARENT_SET_ID_EAV_ATTR_SET_ATTR_SET_ID` (`parent_set_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Product Attribute Set';

--
-- Table structure for table `ves_vendor_product_entity_attribute`
--

DROP TABLE IF EXISTS `ves_vendor_product_entity_attribute`;
CREATE TABLE `ves_vendor_product_entity_attribute` (
  `entity_attribute_id` smallint NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `attribute_set_id` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Set Id',
  `attribute_group_id` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `attribute_id` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `sort_order` smallint DEFAULT NULL COMMENT 'Sort Order',
  PRIMARY KEY (`entity_attribute_id`),
  KEY `FK_C0C8363776F8C7C76ABE77E0FD6D1325` (`attribute_set_id`),
  KEY `FK_EDB8738D4751A943432B87B054B13053` (`attribute_group_id`),
  KEY `VES_VENDOR_PRD_ENTT_ATTR_ATTR_ID_EAV_ATTR_ATTR_ID` (`attribute_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Entity Decimal';

--
-- Table structure for table `ves_vendor_product_update`
--

DROP TABLE IF EXISTS `ves_vendor_product_update`;
CREATE TABLE `ves_vendor_product_update` (
  `update_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `vendor_id` int unsigned NOT NULL COMMENT 'Vendor Id',
  `store_id` int unsigned NOT NULL COMMENT 'Store Id',
  `product_id` int unsigned NOT NULL COMMENT 'Product Id',
  `product_data` longtext NOT NULL COMMENT 'Changed Datas',
  `status` smallint unsigned NOT NULL COMMENT 'Status',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  PRIMARY KEY (`update_id`),
  KEY `VES_VENDOR_PRODUCT_UPDATE_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Product Update';

--
-- Table structure for table `ves_vendor_profile_notification`
--

DROP TABLE IF EXISTS `ves_vendor_profile_notification`;
CREATE TABLE `ves_vendor_profile_notification` (
  `process_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT 'Title',
  `type` varchar(63) NOT NULL DEFAULT '' COMMENT 'Notification Type',
  `additional_data` varchar(255) DEFAULT NULL COMMENT 'Additional Data',
  `sort_order` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Status',
  PRIMARY KEY (`process_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Domain Table';

--
-- Table structure for table `ves_vendor_sales_invoice`
--

DROP TABLE IF EXISTS `ves_vendor_sales_invoice`;
CREATE TABLE `ves_vendor_sales_invoice` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `vendor_id` int unsigned NOT NULL COMMENT 'Vendor Id',
  `vendor_order_id` int unsigned NOT NULL COMMENT 'Vendor Order Id',
  `invoice_id` int unsigned NOT NULL COMMENT 'Base Invoice Id',
  ...
  `customer_note` text COMMENT 'Customer Note',
  PRIMARY KEY (`entity_id`),
  KEY `VES_VENDOR_SALES_INVOICE_GRAND_TOTAL` (`grand_total`),
  KEY `VES_VENDOR_SALES_INVOICE_STATE` (`state`),
  KEY `VES_VENDOR_SALES_INVOICE_CREATED_AT` (`created_at`),
  KEY `VES_VENDOR_SALES_INVOICE_UPDATED_AT` (`updated_at`),
  KEY `VES_VENDOR_SALES_INVOICE_INVOICE_ID_SALES_INVOICE_ENTITY_ID` (`invoice_id`),
  KEY `FK_F1D6EDEF245FEBE212C727A03BE8C926` (`vendor_order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Sales Flat Invoice';

--
-- Table structure for table `ves_vendor_sales_order`
--

DROP TABLE IF EXISTS `ves_vendor_sales_order`;
CREATE TABLE `ves_vendor_sales_order` (
  ...
  `status` varchar(32) DEFAULT NULL COMMENT 'Status',
  `shipping_description` varchar(255) DEFAULT NULL COMMENT 'Shipping Description',
  `discount_seller` decimal(12,2) DEFAULT NULL COMMENT 'Discount of Seller Coupon',
  `discount_mkp` decimal(12,2) DEFAULT NULL COMMENT 'Discount of MKP Coupon',
  `base_discount_amount` decimal(12,4) DEFAULT NULL COMMENT 'Base Discount Amount',
  `base_grand_total` decimal(12,4) DEFAULT NULL COMMENT 'Base Grand Total',
  ...
  `total_qty_ordered` decimal(10,0) unsigned NOT NULL DEFAULT '0' COMMENT 'Total Qty Ordered',
  ...
  `coupon_code` varchar(255) DEFAULT NULL COMMENT 'Coupon Code',
  `discount_description` text COMMENT 'Discount Description',
  PRIMARY KEY (`entity_id`),
  KEY `VES_VENDOR_SALES_ORDER_ORDER_ID_SALES_ORDER_ENTITY_ID` (`order_id`),
  KEY `VES_VENDOR_SALES_ORDER_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Flat Order';

--
-- Table structure for table `ves_vendor_subaccount_role`
--

DROP TABLE IF EXISTS `ves_vendor_subaccount_role`;
CREATE TABLE `ves_vendor_subaccount_role` (
  ...
  PRIMARY KEY (`role_id`),
  KEY `VES_VENDOR_SUBACCOUNT_ROLE_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Role';

--
-- Table structure for table `ves_vendor_subaccount_rule`
--

DROP TABLE IF EXISTS `ves_vendor_subaccount_rule`;
CREATE TABLE `ves_vendor_subaccount_rule` (
  `rule_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `role_id` int unsigned NOT NULL COMMENT 'Role Id',
  `resource_id` varchar(255) DEFAULT NULL COMMENT 'Resource Id',
  PRIMARY KEY (`rule_id`),
  KEY `FK_61AB66ED5181C9C8971CD28F365E7658` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Role';

--
-- Table structure for table `ves_vendor_theme`
--

DROP TABLE IF EXISTS `ves_vendor_theme`;
CREATE TABLE `ves_vendor_theme` (
  `theme_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Theme Id',
  `base_theme_id` int unsigned NOT NULL COMMENT 'Base Theme Id',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT 'Theme Title',
  `preview_image` varchar(255) NOT NULL DEFAULT '' COMMENT 'Preview Image',
  `home_content` mediumtext NOT NULL COMMENT 'Home Content',
  `home_layout` varchar(255) NOT NULL DEFAULT '' COMMENT 'Layout',
  `home_layout_xml` mediumtext NOT NULL COMMENT 'Layout Update Xml',
  `status` smallint unsigned NOT NULL DEFAULT '1' COMMENT 'Status',
  PRIMARY KEY (`theme_id`),
  KEY `VES_VENDOR_THEME_BASE_THEME_ID_THEME_THEME_ID` (`base_theme_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Theme';

--
-- Table structure for table `ves_vendor_theme_config`
--

DROP TABLE IF EXISTS `ves_vendor_theme_config`;
CREATE TABLE `ves_vendor_theme_config` (
  `config_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Theme Id',
  `vendor_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Vendor Id',
  `theme_id` int unsigned NOT NULL COMMENT 'Theme Id',
  `path` varchar(255) NOT NULL DEFAULT '' COMMENT 'Path',
  `value` mediumtext COMMENT 'Preview Image',
  PRIMARY KEY (`config_id`),
  KEY `VES_VENDOR_THEME_CONFIG_THEME_ID_VES_VENDOR_THEME_THEME_ID` (`theme_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Theme Config';

--
-- Table structure for table `ves_vendor_theme_config_section`
--

DROP TABLE IF EXISTS `ves_vendor_theme_config_section`;
CREATE TABLE `ves_vendor_theme_config_section` (
  `section_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Section Id',
  `theme_id` int unsigned NOT NULL COMMENT 'Theme Id',
  `section` varchar(255) NOT NULL DEFAULT '' COMMENT 'Section name',
  PRIMARY KEY (`section_id`),
  KEY `FK_45B799D20C800C10116D4696788698FF` (`theme_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Theme Config Section';

--
-- Table structure for table `ves_vendor_user`
--

DROP TABLE IF EXISTS `ves_vendor_user`;
CREATE TABLE `ves_vendor_user` (
  `customer_id` int unsigned NOT NULL COMMENT 'Customer Account Id',
  `vendor_id` int unsigned NOT NULL COMMENT 'Vendor Account Id',
  `is_super_user` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Is Super User',
  `role_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'Role Id',
  `is_active_user` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Is Active',
  UNIQUE KEY `VES_VENDOR_USER_CUSTOMER_ID_VENDOR_ID` (`customer_id`,`vendor_id`),
  KEY `VES_VENDOR_USER_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor account';

--
-- Dumping data for table `ves_vendor_user`
--

LOCK TABLES `ves_vendor_user` WRITE;
/*!40000 ALTER TABLE `ves_vendor_user` DISABLE KEYS */;
INSERT INTO `ves_vendor_user` VALUES ('2','1',1,'0',1);
/*!40000 ALTER TABLE `ves_vendor_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ves_vendor_withdrawal`
--

DROP TABLE IF EXISTS `ves_vendor_withdrawal`;
CREATE TABLE `ves_vendor_withdrawal` (
  `withdrawal_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Withdrawal Id',
  `vendor_id` int unsigned DEFAULT NULL COMMENT 'Vendor Id',
  `method` varchar(255) DEFAULT NULL COMMENT 'Method',
  ...
  `note` longtext COMMENT 'Note',
  `status` smallint unsigned DEFAULT NULL COMMENT 'Status',
  `code_of_transfer` longtext NOT NULL COMMENT 'Code of Transfer',
  `reason_cancel` longtext NOT NULL COMMENT 'Reason',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  PRIMARY KEY (`withdrawal_id`),
  KEY `VES_VENDOR_WITHDRAWAL_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Withdrawal';

--
-- Table structure for table `ves_vendor_withdrawal_method`
--

DROP TABLE IF EXISTS `ves_vendor_withdrawal_method`;
CREATE TABLE `ves_vendor_withdrawal_method` (
  `method_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Method Id',
  `code` varchar(32) DEFAULT NULL COMMENT 'Method Code',
  `is_enabled` tinyint(1) DEFAULT NULL COMMENT 'Is Enabled',
  `title` varchar(64) DEFAULT NULL COMMENT 'Method Title',
  `description` varchar(255) DEFAULT NULL COMMENT 'Method Description',
  `fee_type` varchar(8) DEFAULT NULL COMMENT 'Fee Type',
  `fee` decimal(12,4) DEFAULT NULL COMMENT 'Method Fee',
  `min_value` decimal(12,4) DEFAULT NULL COMMENT 'Min Amount',
  `max_value` decimal(12,4) DEFAULT NULL COMMENT 'Max Amount',
  `fields` longtext COMMENT 'Method Data',
  PRIMARY KEY (`method_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Vendor Withdrawal Methods';

--
-- Table structure for table `ves_vendor_withdrawal_method_data`
--

DROP TABLE IF EXISTS `ves_vendor_withdrawal_method_data`;
CREATE TABLE `ves_vendor_withdrawal_method_data` (
  `data_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Data Id',
  `method_id` int unsigned NOT NULL COMMENT 'Method Id',
  `vendor_id` int unsigned DEFAULT NULL COMMENT 'Vendor Id',
  `method_data` text COMMENT 'Method Data',
  PRIMARY KEY (`data_id`),
  KEY `FK_8976ED381D086C6D8716F838836A149C` (`vendor_id`),
  KEY `FK_8F45D0C96C52810CFE1F9B7953766996` (`method_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Withdrawal Method Data';
...
--
-- Table structure for table `wiki_bank_card`
--

DROP TABLE IF EXISTS `wiki_bank_card`;
CREATE TABLE `wiki_bank_card` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `full_name` varchar(255) NOT NULL DEFAULT '' COMMENT 'Full_name',
  `account_number` mediumtext COMMENT 'Account_number',
  `bank_name` varchar(255) DEFAULT '' COMMENT 'Bank_name',
  `customer_id` int DEFAULT NULL COMMENT 'Customer_id',
  `check_default` smallint DEFAULT NULL COMMENT 'Check_default',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='wiki_bank_card';

--
-- Table structure for table `wiki_block_customer_account`
--

DROP TABLE IF EXISTS `wiki_block_customer_account`;
CREATE TABLE `wiki_block_customer_account` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `customer_id` int unsigned DEFAULT NULL COMMENT 'Customers Id',
  `vendor_id` int unsigned DEFAULT NULL COMMENT 'Vendors Id',
  `blocked_by` smallint DEFAULT NULL COMMENT '1 - Customers | 2 - Vendors',
  PRIMARY KEY (`id`),
  KEY `CSTR_ENTT_ENTT_ID_WIKI_BLOCK_CSTR_ACCOUNT_CSTR_ID` (`customer_id`),
  KEY `VES_VENDOR_ENTT_ENTT_ID_WIKI_BLOCK_CSTR_ACCOUNT_VENDOR_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Wiki Block';

--
-- Table structure for table `wiki_card_token`
--

DROP TABLE IF EXISTS `wiki_card_token`;
CREATE TABLE `wiki_card_token` (
  `card_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Card Id',
  `customer_id` int unsigned NOT NULL COMMENT 'Customer Id',
  `token` text COMMENT 'Token',
  `type` text NOT NULL COMMENT 'Type',
  `active` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  PRIMARY KEY (`card_id`),
  KEY `WIKI_CARD_TOKEN_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Wiki Card Token';

--
-- Table structure for table `wiki_collect_coupon`
--

DROP TABLE IF EXISTS `wiki_collect_coupon`;
CREATE TABLE `wiki_collect_coupon` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `customer_id` int NOT NULL DEFAULT '1' COMMENT 'Status',
  `rule_id` int NOT NULL COMMENT 'Rule Id',
  `created_at` timestamp NOT NULL COMMENT 'Created At',
  `code` text COMMENT 'Coupon Code',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='User Collect Coupon ';

--
-- Table structure for table `wiki_credit_card`
--

DROP TABLE IF EXISTS `wiki_credit_card`;
CREATE TABLE `wiki_credit_card` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `card_number` varchar(255) NOT NULL DEFAULT '' COMMENT 'Card_number',
  `name_on_card` mediumtext COMMENT 'Name_on_card',
  `expiration_date` varchar(255) DEFAULT '31/12' COMMENT 'Expiration_date',
  `cvv` int DEFAULT NULL COMMENT 'Cvv',
  `customer_id` int DEFAULT NULL COMMENT 'Customer_id',
  `check_default` smallint DEFAULT NULL COMMENT 'Check_default',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='wiki_credit_card';
...
CREATE TABLE `wiki_faq` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT 'Title',
  `type` varchar(255) DEFAULT '' COMMENT 'Type  FAQ',
  `vendor_id` varchar(255) DEFAULT '' COMMENT 'Name Store',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='wiki_faq';

--
-- Table structure for table `wiki_follow`
--

DROP TABLE IF EXISTS `wiki_follow`;
CREATE TABLE `wiki_follow` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `customer_id` int unsigned DEFAULT NULL COMMENT 'Customers Id',
  `vendor_id` int unsigned DEFAULT NULL COMMENT 'Vendors Id',
  PRIMARY KEY (`id`),
  KEY `CUSTOMER_ENTITY_ENTITY_ID_WIKI_FOLLOW_CUSTOMER_ID` (`customer_id`),
  KEY `VES_VENDOR_ENTITY_ENTITY_ID_WIKI_FOLLOW_VENDOR_ID` (`vendor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Wiki Follow';

--
-- Table structure for table `wiki_generate_varchar_code`
--

DROP TABLE IF EXISTS `wiki_generate_varchar_code`;
CREATE TABLE `wiki_generate_varchar_code` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `auto_generate` varchar(12) NOT NULL DEFAULT '' COMMENT 'Auto Generate',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Auto Generate Varchar Code';

--
-- Table structure for table `wiki_interest_entity`
--

DROP TABLE IF EXISTS `wiki_interest_entity`;
CREATE TABLE `wiki_interest_entity` (
  `entity_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `customer_id` int unsigned NOT NULL COMMENT 'Customer Id',
  `image_id` text NOT NULL COMMENT 'Image Id',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Update At',
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Save id image cate of user';

--
-- Table structure for table `wiki_quote_is_active`
--

DROP TABLE IF EXISTS `wiki_quote_is_active`;
CREATE TABLE `wiki_quote_is_active` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `customer_id` int DEFAULT NULL COMMENT 'Customer Id',
  `quote_id` int DEFAULT NULL COMMENT 'Quote Id (is active)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Mapping Quote is active';

--
-- Table structure for table `wiki_report_conversion_rate`
--

DROP TABLE IF EXISTS `wiki_report_conversion_rate`;
CREATE TABLE `wiki_report_conversion_rate` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `total_product_cart` int NOT NULL DEFAULT '0' COMMENT 'Total number of products be added to the cart',
  `total_product_order` int NOT NULL DEFAULT '0' COMMENT 'Total number of products be added to the oder',
  `conversion_rate_cart` int NOT NULL DEFAULT '0' COMMENT 'conversion rate of the order',
  `month` int NOT NULL DEFAULT '0' COMMENT 'Month',
  `vendor_id` int NOT NULL DEFAULT '0' COMMENT 'Vendor id ',
  `created_at` datetime NOT NULL COMMENT 'Created At',
  `update_at` datetime NOT NULL COMMENT 'Update At',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='News Table';

--
-- Table structure for table `wiki_report_sales_seller`
--

DROP TABLE IF EXISTS `wiki_report_sales_seller`;
CREATE TABLE `wiki_report_sales_seller` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `id_order` text COMMENT 'Vendor Id',
  `vendor_id` varchar(255) DEFAULT NULL COMMENT 'Vendor Id',
  `order_date` timestamp NULL DEFAULT NULL COMMENT 'Order Date',
  `date_success_payment` timestamp NULL DEFAULT NULL COMMENT 'Date of successful payment',
  `total_price` decimal(12,2) DEFAULT NULL COMMENT 'Total Price',
  `discount_seller` decimal(12,2) DEFAULT NULL COMMENT 'Discount Price Seller',
  `discount_mkp` decimal(12,2) DEFAULT NULL COMMENT 'Discount Price MKP',
  `discount_mkp_seller` decimal(12,2) DEFAULT NULL COMMENT 'Discount Price MKP',
  `delivery_price` decimal(12,2) DEFAULT NULL COMMENT 'Delivery Price',
  `discount_delivery_seller` decimal(12,2) DEFAULT NULL COMMENT 'Discount Delivery Price Seller',
  `discount_delivery_mkp` decimal(12,2) DEFAULT NULL COMMENT 'Delivery Delivery Price Mkp',
  `total_amount` decimal(12,2) DEFAULT NULL COMMENT 'Total Amount',
  `commission_fees` int DEFAULT NULL COMMENT 'Commission Fees',
  `payment_transaction_fee` decimal(12,2) DEFAULT NULL COMMENT 'Payment Transaction Fee Amount',
  `total_transfer_amount` decimal(12,2) DEFAULT NULL COMMENT 'Total Transfer Amountt',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Report Sales Seller Table';

--
-- Table structure for table `wiki_request_return_order`
--

DROP TABLE IF EXISTS `wiki_request_return_order`;
CREATE TABLE `wiki_request_return_order` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `order_id` int DEFAULT NULL COMMENT 'Order Id',
  `items` text COMMENT 'List Items Id',
  `reason` text COMMENT 'The Reason',
  `picture` text COMMENT 'List Image',
  `content_of_seller` text COMMENT 'Content Confirm of Seller',
  `status_of_seller` smallint DEFAULT '0' COMMENT '1 - Confirm | 2 - Deny',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Mapping Quote is active';

--
-- Table structure for table `wiki_smsnotification`
--

DROP TABLE IF EXISTS `wiki_smsnotification`;
CREATE TABLE `wiki_smsnotification` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  `image` text NOT NULL COMMENT 'Image Notification',
  `obj_user` int unsigned NOT NULL DEFAULT '0' COMMENT 'object user',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='News Table';

--
-- Dumping data for table `wiki_smsnotification`
--

LOCK TABLES `wiki_smsnotification` WRITE;
/*!40000 ALTER TABLE `wiki_smsnotification` DISABLE KEYS */;
INSERT INTO `wiki_smsnotification` VALUES ('1','How to create a simple module','The summary','The description','2022-09-21 10:04:03',1,'','0'),('2','Create a module with custom database table','The summary','The description','2022-09-21 10:04:03',1,'','0'),('3','How to create a simple module','The summary','The description','2022-09-21 10:04:03',1,'','0'),('4','Create a module with custom database table','The summary','The description','2022-09-21 10:04:03',1,'','0');
/*!40000 ALTER TABLE `wiki_smsnotification` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wiki_user_setting`
--

DROP TABLE IF EXISTS `wiki_user_setting`;
CREATE TABLE `wiki_user_setting` (
  `setting_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Setting Id',
  `customer_id` int unsigned NOT NULL COMMENT 'Customer Id',
  `setting_data` text COMMENT 'Setting Data',
  PRIMARY KEY (`setting_id`),
  KEY `WIKI_USER_SETTING_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Wiki User Setting';
...
INSERT INTO `wishlist` VALUES ('1','1',0,'7kvLoNRlEbSbSK8wqNSwxSq6OgN6mTy6','2022-09-21 10:53:10'),('2','2',0,'2Rbek6P6wpAjXutxNrzWJq5uDEVw65cm','2022-09-22 03:41:09');
...
--
-- Table structure for table `wk_chat_message_image`
--

DROP TABLE IF EXISTS `wk_chat_message_image`;
CREATE TABLE `wk_chat_message_image` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `action_id` int unsigned NOT NULL COMMENT 'Chat ID',
  `image` text NOT NULL COMMENT 'Image',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  PRIMARY KEY (`id`),
  KEY `WK_CHAT_MESSAGE_IMAGE_ACTION_ID_WK_CHAT_ROOM_ACTION_ACTION_ID` (`action_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Chat Message Image';

--
-- Table structure for table `wk_chat_room`
--

DROP TABLE IF EXISTS `wk_chat_room`;
CREATE TABLE `wk_chat_room` (
  `chat_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `customer_id` int DEFAULT NULL,
  `vendor_id` varchar(50) NOT NULL,
  `is_read` smallint DEFAULT '0' COMMENT 'Is Read Message',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Updated At',
  `id_ticket` int DEFAULT NULL COMMENT 'ID Ticket',
  PRIMARY KEY (`chat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Chat Chat room';

--
-- Table structure for table `wk_chat_room_action`
--

DROP TABLE IF EXISTS `wk_chat_room_action`;
CREATE TABLE `wk_chat_room_action` (
  `action_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `chat_id` int unsigned NOT NULL COMMENT 'Chat ID',
  `message` text,
  `sender_id` varchar(50) NOT NULL,
  `sender_type` varchar(20) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `from_system` smallint DEFAULT '0' COMMENT 'From System',
  PRIMARY KEY (`action_id`),
  KEY `WK_CHAT_ROOM_ACTION_CHAT_ID_WK_CHAT_ROOM_CHAT_ID` (`chat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Chat Room Action';
...
ALTER TABLE `mgs_blog_category_post`
  ADD CONSTRAINT `MGS_BLOG_CATEGORY_POST_CATEGORY_ID_MGS_BLOG_CATEGORY_CATEGORY_ID` FOREIGN KEY (`category_id`) REFERENCES `mgs_blog_category` (`category_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `MGS_BLOG_CATEGORY_POST_POST_ID_MGS_BLOG_POST_POST_ID` FOREIGN KEY (`post_id`) REFERENCES `mgs_blog_post` (`post_id`) ON DELETE CASCADE;

ALTER TABLE `mgs_blog_category_store`
  ADD CONSTRAINT `MGS_BLOG_CATEGORY_STORE_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `MGS_BLOG_CTGR_STORE_CTGR_ID_MGS_BLOG_CTGR_CTGR_ID` FOREIGN KEY (`category_id`) REFERENCES `mgs_blog_category` (`category_id`) ON DELETE CASCADE;

ALTER TABLE `mgs_blog_post_store`
  ADD CONSTRAINT `MGS_BLOG_POST_STORE_POST_ID_MGS_BLOG_POST_POST_ID` FOREIGN KEY (`post_id`) REFERENCES `mgs_blog_post` (`post_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `MGS_BLOG_POST_STORE_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE;

ALTER TABLE `mgs_brand_category`
  ADD CONSTRAINT `MGS_BRAND_CATEGORY_BRAND_ID_MGS_BRAND_BRAND_ID` FOREIGN KEY (`brand_id`) REFERENCES `mgs_brand` (`brand_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `MGS_BRAND_CATEGORY_CATEGORY_ID_CATALOG_CATEGORY_ENTITY_ENTITY_ID` FOREIGN KEY (`category_id`) REFERENCES `catalog_category_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `mgs_brand_store`
  ADD CONSTRAINT `MGS_BRAND_STORE_BRAND_ID_MGS_BRAND_BRAND_ID` FOREIGN KEY (`brand_id`) REFERENCES `mgs_brand` (`brand_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `MGS_BRAND_STORE_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE;
...
ALTER TABLE `store_locator_store`
  ADD CONSTRAINT `STORE_LOCATOR_STORE_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `STORE_LOCATOR_STORE_STORELOCATOR_ID_STORE_LOCATOR_ID` FOREIGN KEY (`storelocator_id`) REFERENCES `store_locator` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `ves_store_credit`
  ADD CONSTRAINT `VES_STORE_CREDIT_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_store_credit_transaction`
  ADD CONSTRAINT `VES_STORE_CREDIT_TRANSACTION_CSTR_ID_VES_STORE_CREDIT_CSTR_ID` FOREIGN KEY (`customer_id`) REFERENCES `ves_store_credit` (`customer_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_config`
  ADD CONSTRAINT `VES_VENDOR_CONFIG_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_config_update`
  ADD CONSTRAINT `VES_VENDOR_CONFIG_UPDATE_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_coupon`
  ADD CONSTRAINT `VES_VENDOR_COUPON_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_eav_attribute`
  ADD CONSTRAINT `VES_VENDOR_EAV_ATTRIBUTE_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_entity`
  ADD CONSTRAINT `VES_VENDOR_ENTITY_WEBSITE_ID_STORE_WEBSITE_WEBSITE_ID` FOREIGN KEY (`website_id`) REFERENCES `store_website` (`website_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_entity_datetime`
  ADD CONSTRAINT `VES_VENDOR_ENTITY_DATETIME_ENTITY_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTT_DTIME_ATTR_ID_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_entity_decimal`
  ADD CONSTRAINT `VES_VENDOR_ENTITY_DECIMAL_ENTITY_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTT_DEC_ATTR_ID_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_entity_int`
  ADD CONSTRAINT `VES_VENDOR_ENTITY_INT_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTITY_INT_ENTITY_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_entity_text`
  ADD CONSTRAINT `VES_VENDOR_ENTITY_TEXT_ATTRIBUTE_ID_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTITY_TEXT_ENTITY_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_entity_varchar`
  ADD CONSTRAINT `VES_VENDOR_ENTITY_VARCHAR_ENTITY_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTT_VCHR_ATTR_ID_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_escrow`
  ADD CONSTRAINT `VES_VENDOR_ESCROW_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_fieldset_attr`
  ADD CONSTRAINT `VENDOR_FIELDSET_ATTR_FIELDSET_ID_VENDOR_FIELDSET_FIELDSET_ID` FOREIGN KEY (`fieldset_id`) REFERENCES `ves_vendor_fieldset` (`fieldset_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_notification`
  ADD CONSTRAINT `VES_VENDOR_NOTIFICATION_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_product_attribute_group`
  ADD CONSTRAINT `FK_E59566E2E3546C51ED5ECC8BF47F5F18` FOREIGN KEY (`attribute_set_id`) REFERENCES `ves_vendor_product_attribute_set` (`attribute_set_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_product_attribute_set`
  ADD CONSTRAINT `VES_VENDOR_PRD_ATTR_SET_PARENT_SET_ID_EAV_ATTR_SET_ATTR_SET_ID` FOREIGN KEY (`parent_set_id`) REFERENCES `eav_attribute_set` (`attribute_set_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_product_entity_attribute`
  ADD CONSTRAINT `FK_C0C8363776F8C7C76ABE77E0FD6D1325` FOREIGN KEY (`attribute_set_id`) REFERENCES `ves_vendor_product_attribute_set` (`attribute_set_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_EDB8738D4751A943432B87B054B13053` FOREIGN KEY (`attribute_group_id`) REFERENCES `ves_vendor_product_attribute_group` (`group_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_PRD_ENTT_ATTR_ATTR_ID_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `eav_attribute` (`attribute_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_product_update`
  ADD CONSTRAINT `VES_VENDOR_PRODUCT_UPDATE_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_sales_invoice`
  ADD CONSTRAINT `FK_F1D6EDEF245FEBE212C727A03BE8C926` FOREIGN KEY (`vendor_order_id`) REFERENCES `ves_vendor_sales_order` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_SALES_INVOICE_INVOICE_ID_SALES_INVOICE_ENTITY_ID` FOREIGN KEY (`invoice_id`) REFERENCES `sales_invoice` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_sales_order`
  ADD CONSTRAINT `VES_VENDOR_SALES_ORDER_ORDER_ID_SALES_ORDER_ENTITY_ID` FOREIGN KEY (`order_id`) REFERENCES `sales_order` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_SALES_ORDER_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_subaccount_role`
  ADD CONSTRAINT `VES_VENDOR_SUBACCOUNT_ROLE_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_subaccount_rule`
  ADD CONSTRAINT `FK_61AB66ED5181C9C8971CD28F365E7658` FOREIGN KEY (`role_id`) REFERENCES `ves_vendor_subaccount_role` (`role_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_theme`
  ADD CONSTRAINT `VES_VENDOR_THEME_BASE_THEME_ID_THEME_THEME_ID` FOREIGN KEY (`base_theme_id`) REFERENCES `theme` (`theme_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_theme_config`
  ADD CONSTRAINT `VES_VENDOR_THEME_CONFIG_THEME_ID_VES_VENDOR_THEME_THEME_ID` FOREIGN KEY (`theme_id`) REFERENCES `ves_vendor_theme` (`theme_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_theme_config_section`
  ADD CONSTRAINT `FK_45B799D20C800C10116D4696788698FF` FOREIGN KEY (`theme_id`) REFERENCES `ves_vendor_theme` (`theme_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_user`
  ADD CONSTRAINT `VES_VENDOR_USER_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_USER_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_withdrawal`
  ADD CONSTRAINT `VES_VENDOR_WITHDRAWAL_VENDOR_ID_VES_VENDOR_ENTITY_ENTITY_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `ves_vendor_withdrawal_method_data`
  ADD CONSTRAINT `FK_8976ED381D086C6D8716F838836A149C` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_8F45D0C96C52810CFE1F9B7953766996` FOREIGN KEY (`method_id`) REFERENCES `ves_vendor_withdrawal_method` (`method_id`) ON DELETE CASCADE;
...
ALTER TABLE `wiki_block_customer_account`
  ADD CONSTRAINT `CSTR_ENTT_ENTT_ID_WIKI_BLOCK_CSTR_ACCOUNT_CSTR_ID` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTT_ENTT_ID_WIKI_BLOCK_CSTR_ACCOUNT_VENDOR_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `wiki_card_token`
  ADD CONSTRAINT `WIKI_CARD_TOKEN_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `wiki_follow`
  ADD CONSTRAINT `CUSTOMER_ENTITY_ENTITY_ID_WIKI_FOLLOW_CUSTOMER_ID` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `VES_VENDOR_ENTITY_ENTITY_ID_WIKI_FOLLOW_VENDOR_ID` FOREIGN KEY (`vendor_id`) REFERENCES `ves_vendor_entity` (`entity_id`) ON DELETE CASCADE;

ALTER TABLE `wiki_user_setting`
  ADD CONSTRAINT `WIKI_USER_SETTING_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE;
...
ALTER TABLE `wk_chat_message_image`
  ADD CONSTRAINT `WK_CHAT_MESSAGE_IMAGE_ACTION_ID_WK_CHAT_ROOM_ACTION_ACTION_ID` FOREIGN KEY (`action_id`) REFERENCES `wk_chat_room_action` (`action_id`) ON DELETE CASCADE;

ALTER TABLE `wk_chat_room_action`
  ADD CONSTRAINT `WK_CHAT_ROOM_ACTION_CHAT_ID_WK_CHAT_ROOM_CHAT_ID` FOREIGN KEY (`chat_id`) REFERENCES `wk_chat_room` (`chat_id`) ON DELETE CASCADE;
...
-- Dump completed on 2022-09-22 07:39:19 GMT